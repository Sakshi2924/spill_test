...
import React172, { useCallback as useCallback129, useEffect as useEffect76, useMemo as useMemo129 } from "react";
...
import { createRef as createRef5, useCallback as useCallback21, useImperativeHandle as useImperativeHandle5, useState as useState19 } from "react";
...
import React24, { useCallback as useCallback17, useContext as useContext10, useMemo as useMemo23, useRef as useRef11, useState as useState15 } from "react";
...
import { useCallback as useCallback20, useMemo as useMemo26, useState as useState18 } from "react";
...
var Tab = ({ children, onClick, style, selected }) => {
  ...
  const { tabIndex } = useZIndex();
  const onPointerEnter = useCallback20(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback20(() => {
    setHovered(false);
  }, []);
  const definiteStyle = useMemo26(() => ({
    ...selectorButton,
...
var ExplorerPanel = ({ readOnlyStudio }) => {
  ...
  const onCompositionsSelected = useCallback21(() => {
    setPanel("compositions");
    persistSelectedOptionsSidebarPanel("compositions");
  }, []);
  const onAssetsSelected = useCallback21(() => {
    setPanel("assets");
...
import { useCallback as useCallback92, useMemo as useMemo97, useState as useState61 } from "react";
...
import { useCallback as useCallback23, useContext as useContext14 } from "react";
...
import { useCallback as useCallback25, useEffect as useEffect15, useMemo as useMemo28, useRef as useRef13, useState as useState21 } from "react";
...
import { useContext as useContext17, useEffect as useEffect20, useMemo as useMemo32, useRef as useRef16 } from "react";
...
import { jsx as jsx52, jsxs as jsxs17, Fragment as Fragment8 } from "react/jsx-runtime";
var viewBox = 100;
var lines = 8;
...
var Spinner = ({ size, duration }) => {
  ...
  return /* @__PURE__ */ jsxs17(Fragment8, {
    children: [
...
var CompWhenItHasDimensions = ({ contentDimensions, canvasSize, canvasContent, assetMetadata }) => {
  ...
  return /* @__PURE__ */ jsx54("div", {
    style: outer,
    children: canvasContent.type === "asset" ? /* @__PURE__ */ jsx54(StaticFilePreview, {
      assetMetadata,
      currentAsset: canvasContent.asset
    }) : canvasContent.type === "output" ? /* @__PURE__ */ jsx54(RenderPreview, {
      path: canvasContent.path,
      assetMetadata
    }) : /* @__PURE__ */ jsx54(PortalContainer, {
      contentDimensions,
      scale,
      xCorrection,
      yCorrection
...
var PortalContainer = ({ scale, xCorrection, yCorrection, contentDimensions }) => {
  ...
  const portalContainer = useRef16(null);
  return /* @__PURE__ */ jsx54("div", {
    ref: portalContainer,
    style: style3
  });
...
// src/components/TimelineInOutToggle.tsx
import { jsx as jsx57, jsxs as jsxs19, Fragment as Fragment9 } from "react/jsx-runtime";
...
var TimelineInOutPointToggle = () => {
  ...
  const onInOutClear = useCallback26((composition) => {
  ...
  const onInMark = useCallback26((e) => {
    if (!videoConfig) {
      return null;
    }
    if (e?.shiftKey) {
  ...
  const clearInMark = useCallback26((e) => {
    if (!videoConfig) {
      return null;
    }
    e.preventDefault();
  ...
  const clearOutMark = useCallback26((e) => {
    if (!videoConfig) {
      return null;
    }
    e?.preventDefault();
  ...
  const onOutMark = useCallback26((e) => {
    if (!videoConfig) {
      return null;
    }
    if (e?.shiftKey) {
  ...
  return /* @__PURE__ */ jsxs19(Fragment9, {
    children: [
...
import { jsx as jsx60, jsxs as jsxs21, Fragment as Fragment10 } from "react/jsx-runtime";
var pickColor = () => {
  const open = new EyeDropper().open();
  open.then((color) => {
    copyText(color.sRGBHex).then(() => {
      showNotification(/* @__PURE__ */ jsxs21(Fragment10, {
        children: [
...
import { useCallback as useCallback27, useMemo as useMemo38, useRef as useRef17, useState as useState26 } from "react";
import ReactDOM5 from "react-dom";
import { jsx as jsx62, jsxs as jsxs22, Fragment as Fragment11 } from "react/jsx-runtime";
var container15 = {
  fontSize: 13,
  color: "white",
  paddingLeft: 10,
...
var MenuItem = ({
  ...
  const onPointerDown = useCallback27((e) => {
    if (e.button !== 0) {
      return;
    }
    onItemSelected(id);
  ...
  return /* @__PURE__ */ jsxs22(Fragment11, {
    children: [
...
import { useContext as useContext21, useEffect as useEffect22, useState as useState28 } from "react";

// src/components/OpenEditorButton.tsx
import { useCallback as useCallback28, useMemo as useMemo39, useState as useState27 } from "react";
...
import { useCallback as useCallback90, useContext as useContext57, useEffect as useEffect57 } from "react";

// src/components/TopPanel.tsx
import { useCallback as useCallback89, useContext as useContext56, useEffect as useEffect56, useMemo as useMemo95 } from "react";
...
import { useContext as useContext30, useMemo as useMemo50 } from "react";
import { Internals as Internals25 } from "remotion";

// src/components/CanvasOrLoading.tsx
import { useContext as useContext29, useEffect as useEffect33 } from "react";
...
import { useCallback as useCallback29, useEffect as useEffect24 } from "react";
...
var AskOnDiscord = ({ canHaveKeyboardShortcuts }) => {
  const openInBrowser = useCallback29(() => {
...
import { useCallback as useCallback31, useMemo as useMemo41, useRef as useRef18, useState as useState30 } from "react";
...
var ErrorMessage = ({ message }) => {
  ...
  return /* @__PURE__ */ jsxs26("div", {
    ...
    children: [
      ...
      errorLines !== null && errorLines > maxLines ? /* @__PURE__ */ jsx70("div", {
        style: moreLine,
        children: /* @__PURE__ */ jsx70("button", {
          type: "button",
          onClick: toggle,
          style: moreButton,
          children: /* @__PURE__ */ jsx70(CaretDown2, {
            invert: expanded
          })
        })
      }) : null
  ...
  return /* @__PURE__ */ jsxs27("svg", {
    ...
    children: [
      /* @__PURE__ */ jsx71("path", {
        ...
        children: /* @__PURE__ */ jsx71("animate", {
...
import { jsx as jsx72, jsxs as jsxs28, Fragment as Fragment12 } from "react/jsx-runtime";
var title2 = {
  marginBottom: 8,
  display: "flex",
  flexDirection: "row",
...
var ErrorTitle = ({ name, message, symbolicating, canHaveDismissButton }) => {
  return /* @__PURE__ */ jsxs28("div", {
    ...
    children: [
      /* @__PURE__ */ jsxs28("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs28("div", {
            style: row2,
            children: [
              symbolicating ? /* @__PURE__ */ jsxs28(Fragment12, {
                children: [
                  /* @__PURE__ */ jsx72(Symbolicating, {}),
                  /* @__PURE__ */ jsx72("div", {
                    style: spacer
                  })
                ]
              }) : null,
              /* @__PURE__ */ jsx72(ErrorMessage, {
                message
              })
            ]
          })
      ...
      didUnmountReactApp() ? null : canHaveDismissButton ? /* @__PURE__ */ jsx72(DismissButton, {}) : null
    ]
  });
};

// src/error-overlay/remotion-overlay/HelpLink.tsx
import { useCallback as useCallback32, useEffect as useEffect25 } from "react";
...
var OpenInEditor = ({ stack, canHaveKeyboardShortcuts }) => {
  const isMounted = useRef19(true);
  const [state, dispatch] = useReducer(reducer, initialState);
  const { registerKeybinding } = useKeybinding();
  const dispatchIfMounted = useCallback33((payload) => {
  ...
  return /* @__PURE__ */ jsxs30(Button, {
    ...
    children: [
      label4,
      canHaveKeyboardShortcuts ? /* @__PURE__ */ jsx74(ShortcutHint, {
        keyToPress: "o",
        cmdOrCtrl: true
      }) : null
    ]
...
import { useCallback as useCallback34, useEffect as useEffect27 } from "react";
...
import { useCallback as useCallback35, useState as useState31 } from "react";
        ...
        children: [
          /* @__PURE__ */ jsxs33("div", {
            ...
            children: [
              ...
              s.originalFileName ? /* @__PURE__ */ jsxs33("div", {
                style: location,
                children: [
          ...
          s.originalScriptCode && s.originalScriptCode.length > 0 ? /* @__PURE__ */ jsx78(Button, {
            onClick: toggleCodeFrame,
            children: showCodeFrame ? /* @__PURE__ */ jsx78(CaretDown2, {
              invert: false
            }) : /* @__PURE__ */ jsx78(CaretRight2, {})
          }) : null
        ]
      }),
      /* @__PURE__ */ jsx78("div", {
        children: s.originalScriptCode && s.originalScriptCode.length > 0 && showCodeFrame ? /* @__PURE__ */ jsx78(CodeFrame, {
          lineNumberWidth,
...
// src/error-overlay/remotion-overlay/ErrorDisplay.tsx
import { jsx as jsx79, jsxs as jsxs34, Fragment as Fragment13 } from "react/jsx-runtime";
var stack = {
  marginTop: 17,
  overflowX: "scroll",
  marginBottom: "10vh"
...
`).replace(/\\t/g, "  ").replace(/^error:/, "").trim();
  ...
  return /* @__PURE__ */ jsxs34("div", {
    children: [
      /* @__PURE__ */ jsx79(ErrorTitle, {
        symbolicating: false,
        name: display.error.name,
        message,
        canHaveDismissButton
      }),
      helpLink ? /* @__PURE__ */ jsxs34(Fragment13, {
        children: [
          /* @__PURE__ */ jsx79(HelpLink, {
            link: helpLink,
      ...
      display.stackFrames.length > 0 && window.remotion_editorName ? /* @__PURE__ */ jsxs34(Fragment13, {
        children: [
          /* @__PURE__ */ jsx79(OpenInEditor, {
            canHaveKeyboardShortcuts: keyboardShortcuts,
      ...
      /* @__PURE__ */ jsx79(SearchGithubIssues, {
        canHaveKeyboardShortcuts: keyboardShortcuts,
      ...
      /* @__PURE__ */ jsx79(AskOnDiscord, {
        canHaveKeyboardShortcuts: keyboardShortcuts
      }),
      onRetry ? /* @__PURE__ */ jsxs34(Fragment13, {
        children: [
          /* @__PURE__ */ jsx79("div", {
            style: spacer2
          }),
          /* @__PURE__ */ jsx79(RetryButton, {
            onClick: onRetry
          })
        ]
      }) : null,
      calculateMetadata ? /* @__PURE__ */ jsxs34(Fragment13, {
        children: [
          /* @__PURE__ */ jsx79("br", {}),
          /* @__PURE__ */ jsx79(Spacing, {
            y: 0.5
          }),
          /* @__PURE__ */ jsx79(CalculateMetadataErrorExplainer, {})
        ]
      }) : null,
      /* @__PURE__ */ jsx79("div", {
        style: stack,
        ...
        children: display.stackFrames.map((s, i) => {
          return /* @__PURE__ */ jsx79(StackElement, {
            isFirst: i === 0,
            s,
            lineNumberWidth,
...
var ErrorLoader = ({
  ...
  if (state.type === "loading") {
    return /* @__PURE__ */ jsx80("div", {
      style: container18,
      children: /* @__PURE__ */ jsx80(ErrorTitle, {
        symbolicating: true,
        name: error.name,
  ...
  return /* @__PURE__ */ jsx80("div", {
    style: container18,
    children: /* @__PURE__ */ jsx80(ErrorDisplay, {
      keyboardShortcuts,
...
import { useContext as useContext24, useMemo as useMemo46 } from "react";
...
import { useContext as useContext22, useMemo as useMemo44 } from "react";
...
import { memo, useCallback as useCallback36, useContext as useContext23, useMemo as useMemo45 } from "react";
...
var GuideComp = ({ guide, canvasDimensions, scale }) => {
  ...
  const onPointerEnter = useCallback36(() => {
    setHoveredGuideId(() => guide.id);
  }, [guide.id, setHoveredGuideId]);
  const onPointerLeave = useCallback36(() => {
  ...
  return /* @__PURE__ */ jsx81(ContextMenu, {
    values,
    children: /* @__PURE__ */ jsx81("div", {
      style: guideStyle,
      onMouseDown,
...
// src/components/EditorGuides/index.tsx
import { jsx as jsx82, Fragment as Fragment14 } from "react/jsx-runtime";
var EditorGuides = ({ canvasSize, contentDimensions, assetMetadata }) => {
  ...
  return /* @__PURE__ */ jsx82(Fragment14, {
    children: guidesForThisComposition.map((guide) => {
      return /* @__PURE__ */ jsx82(Guide_default, {
        guide,
        canvasDimensions,
        scale
      }, guide.id);
...
var Ruler = ({
  ...
  const rulerCanvasRef = useRef20(null);
  ...
  const changeCursor = useCallback37((e) => {
    e.preventDefault();
...
// src/components/EditorRuler/index.tsx
import { jsx as jsx84, jsxs as jsxs36, Fragment as Fragment15 } from "react/jsx-runtime";
...
var EditorRulers = ({ contentDimensions, canvasSize, assetMetadata, containerRef }) => {
  ...
  const requestAnimationFrameRef = useRef21(null);
  const onMouseMove = useCallback38((e) => {
  ...
  return /* @__PURE__ */ jsxs36(Fragment15, {
    children: [
      /* @__PURE__ */ jsx84("div", {
        style: originBlockStyles
      }),
      /* @__PURE__ */ jsx84(Ruler_default, {
...
// src/components/Canvas.tsx
import { jsx as jsx86, jsxs as jsxs37, Fragment as Fragment16 } from "react/jsx-runtime";
var container19 = {
  flex: 1,
  display: "flex",
  overflow: "hidden",
...
var Canvas = ({ canvasContent, size: size2 }) => {
  ...
  const fetchMetadata = useCallback39(async () => {
  ...
  return /* @__PURE__ */ jsxs37(Fragment16, {
    children: [
      /* @__PURE__ */ jsxs37("div", {
        ref: canvasRef,
        style: container19,
        children: [
          size2 ? /* @__PURE__ */ jsx86(VideoPreview, {
            canvasContent,
            contentDimensions,
            canvasSize: size2,
            assetMetadata: assetResolution
          }) : null,
          isFit ? null : /* @__PURE__ */ jsx86("div", {
            style: resetZoom,
            className: "css-reset",
            children: /* @__PURE__ */ jsx86(ResetZoomButton, {
              onClick: onReset
            })
          }),
          editorShowGuides && canvasContent.type === "composition" && /* @__PURE__ */ jsx86(EditorGuides_default, {
            canvasSize: size2,
            contentDimensions,
            assetMetadata: assetResolution
          })
      ...
      areRulersVisible && /* @__PURE__ */ jsx86(EditorRulers, {
        contentDimensions,
        canvasSize: size2,
        assetMetadata: assetResolution,
...
var RunningCalculateMetadata = () => {
  return /* @__PURE__ */ jsxs38("div", {
    style: container20,
    children: [
      /* @__PURE__ */ jsx87(Spinner, {
        size: 24,
        duration: 1
      }),
      /* @__PURE__ */ jsx87(Spacing, {
        x: 2
      }),
      /* @__PURE__ */ jsxs38("div", {
        style: loaderLabel,
...
var RefreshCompositionOverlay = () => {
  return /* @__PURE__ */ jsx88(AbsoluteFill2, {
    style: container21,
    children: /* @__PURE__ */ jsx88("div", {
      style: shadow,
      children: /* @__PURE__ */ jsx88(RunningCalculateMetadata, {})
    })
  });
};

// src/components/CanvasOrLoading.tsx
import { jsx as jsx89, jsxs as jsxs39, Fragment as Fragment17 } from "react/jsx-runtime";
var container22 = {
  color: "white",
  flex: 1,
  justifyContent: "center",
...
var CanvasOrLoading = ({ size: size2 }) => {
  ...
  const content = /* @__PURE__ */ jsxs39(Fragment17, {
    children: [
      /* @__PURE__ */ jsx89(ZoomPersistor, {}),
      /* @__PURE__ */ jsx89(Canvas, {
        size: size2,
        canvasContent
      }),
      resolved?.type === "success-and-refreshing" ? /* @__PURE__ */ jsx89(RefreshCompositionOverlay, {}) : null
    ]
  });
  ...
  if (resolved.type === "loading") {
    return /* @__PURE__ */ jsx89("div", {
      style: container22,
      className: "css-reset",
      children: /* @__PURE__ */ jsx89(RunningCalculateMetadata, {})
    });
  }
  if (resolved.type === "error") {
    return /* @__PURE__ */ jsx89(ErrorLoading, {
      error: resolved.error
    });
  }
  return /* @__PURE__ */ jsxs39(Fragment17, {
    children: [
      /* @__PURE__ */ jsx89(FramePersistor, {}),
      " ",
      content
    ]
  });
...
var ErrorLoading = ({ error }) => {
  return /* @__PURE__ */ jsx89("div", {
    ...
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: /* @__PURE__ */ jsx89(ErrorLoader, {
...
var CanvasIfSizeIsAvailable = () => {
  ...
  return /* @__PURE__ */ jsx90(CanvasOrLoading, {
    size: sizeWithRulersApplied
  });
};

// src/components/CurrentCompositionSideEffects.tsx
import { useCallback as useCallback40, useContext as useContext31, useEffect as useEffect34 } from "react";
...
var CurrentCompositionKeybindings = ({ readOnlyStudio }) => {
  ...
  const openRenderModal = useCallback40(() => {
    if (!video) {
      return;
    }
    if (readOnlyStudio) {
...
function MobilePanel({
  ...
  const { currentZIndex } = useZIndex();
  return ReactDOM6.createPortal(/* @__PURE__ */ jsxs40("div", {
    style: container23,
    children: [
      /* @__PURE__ */ jsx91("div", {
        style: buttonContainer,
        children: /* @__PURE__ */ jsx91(CancelButton, {
          style: button2,
          onPress: onClose
        })
      }),
...
var ZodProvider = ({ children }) => {
  const [zod, setZod] = useState35(null);
  const [zodTypes, setZodTypes] = useState35(null);
  useEffect35(() => {
  ...
  const contextValue = useMemo51(() => {
    return {
      zod,
      zodTypes
    };
  }, [zod, zodTypes]);
  return /* @__PURE__ */ jsx92(ZodContext.Provider, {
    value: contextValue,
    children
  });
};
...
var VisualControlsProvider = ({ children }) => {
  const imperativeHandles = useRef22({});
  const [handles, setHandles] = useState36({});
  const state = useMemo52(() => {
    return {
      handles
    };
  }, [handles]);
  const setControl = useCallback41((key, value) => {
  ...
  const updateValue = useCallback41((key, value) => {
    imperativeHandles.current = {
      ...imperativeHandles.current,
      [key]: {
  ...
  return /* @__PURE__ */ jsx93(VisualControlsTabActivatedContext.Provider, {
    value: Object.keys(state.handles).length > 0,
    children: /* @__PURE__ */ jsx93(VisualControlsContext.Provider, {
      value: state,
      children: /* @__PURE__ */ jsx93(SetVisualControlsContext.Provider, {
        value: setState,
        children
      })
    })
...
import React61, { useCallback as useCallback44, useContext as useContext33 } from "react";
...
var SchemaResetButton = ({ onClick }) => {
  const renderAction = useCallback42((color) => {
    return /* @__PURE__ */ jsx94("svg", {
      style: icon2,
      viewBox: "0 0 512 512",
      children: /* @__PURE__ */ jsx94("path", {
        fill: color,
        d: "M48.5 224H40c-13.3 0-24-10.7-24-24V72c0-9.7 5.8-18.5 14.8-22.2s19.3-1.7 26.2 5.2L98.6 96.6c87.6-86.5 228.7-86.2 315.8 1c87.5 87.5 87.5 229.3 0 316.8s-229.3 87.5-316.8 0c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0c62.5 62.5 163.8 62.5 226.3 0s62.5-163.8 0-226.3c-62.2-62.2-162.7-62.5-225.3-1L185 183c6.9 6.9 8.9 17.2 5.2 26.2s-12.5 14.8-22.2 14.8H48.5z"
      })
    });
  }, []);
  return /* @__PURE__ */ jsx94(InlineAction, {
    renderAction,
    onClick
  });
};
...
var SchemaSaveButton = ({ onClick, disabled }) => {
  ...
  return /* @__PURE__ */ jsx95(InlineAction, {
    renderAction,
    onClick,
    disabled
  });
...
var GlobalPropsEditorUpdateButton = ({ compositionId, currentDefaultProps }) => {
  ...
  const [disabled, setDisabled] = React61.useState(false);
  const onClicked = useCallback44(() => {
    setDisabled(true);
  ...
  return /* @__PURE__ */ jsxs41("div", {
    style: container24,
    children: [
      /* @__PURE__ */ jsx96(SchemaResetButton, {
        onClick: onReset
      }),
      /* @__PURE__ */ jsx96(SchemaSaveButton, {
        disabled,
        onClick: onClicked
      })
    ]
...
import { jsx as jsx97, jsxs as jsxs42 } from "react/jsx-runtime";
...
var ValidationMessage = ({ message, align, type }) => {
  ...
  return /* @__PURE__ */ jsx97("div", {
    style: container25,
    children: /* @__PURE__ */ jsxs42(Row, {
      align: "center",
      justify: align,
      children: [
        /* @__PURE__ */ jsx97(WarningTriangle, {
          style: finalStyle
        }),
...
import { useCallback as useCallback45, useMemo as useMemo54, useState as useState37 } from "react";
...
var Item = ({ selected, onClick, children }) => {
  ...
  const { tabIndex } = useZIndex();
  const onPointerEnter = useCallback45(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback45(() => {
    setHovered(false);
  }, []);
  const itemStyle3 = useMemo54(() => {
    return {
      ...item,
...
import React65, { useCallback as useCallback46, useEffect as useEffect37, useMemo as useMemo56 } from "react";
...
var ZodErrorMessages = ({ zodValidationResult, viewTab }) => {
  ...
  const style7 = useMemo55(() => {
    return viewTab === "json" ? jsonLabel : schemaLabel;
  }, [viewTab]);
  const code = useMemo55(() => {
    return {
      ...schemaLabel,
      fontFamily: "monospace"
    };
...
var RenderModalJSONPropsEditor = ({
  ...
  const keybindings = useKeybinding();
  const [localValue, setLocalValue] = React65.useState(() => {
    return parseJSON(serializedJSON.serializedString, schema);
  });
  const onPretty = useCallback46(() => {
  ...
  const onChange = useCallback46((e) => {
  ...
  return /* @__PURE__ */ jsxs44("div", {
    style: scrollable,
    children: [
      /* @__PURE__ */ jsx100(RemTextarea, {
        onChange,
        value: localValue.str,
        status: localValue.validJSON ? "ok" : "error",
        style: textAreaStyle
      }),
      /* @__PURE__ */ jsx100(Spacing, {
        y: 1
      }),
      localValue.validJSON === false ? /* @__PURE__ */ jsx100(ValidationMessage, {
        align: "flex-start",
        message: localValue.error,
        type: "error"
      }) : localValue.zodValidation.success === false ? /* @__PURE__ */ jsx100(ZodErrorMessages, {
      ...
      /* @__PURE__ */ jsxs44(Row, {
        children: [
          ...
          showSaveButton ? /* @__PURE__ */ jsx100(Button, {
            onClick: onSave,
...
import { useCallback as useCallback66, useEffect as useEffect42, useMemo as useMemo77, useState as useState48 } from "react";
...
var InvalidDefaultProps = ({ zodValidationResult }) => {
  return /* @__PURE__ */ jsxs45("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx101(ZodErrorMessages, {
        zodValidationResult,
        viewTab: "schema"
      }),
      /* @__PURE__ */ jsx101(Spacing, {
...
import React89, { useMemo as useMemo76, useState as useState47 } from "react";
...
import { createContext as createContext17, useContext as useContext34, useMemo as useMemo57 } from "react";
...
var Fieldset = ({ children, shouldPad }) => {
  ...
  const content = /* @__PURE__ */ jsx102("div", {
    style: style8,
    children
  });
  if (shouldPad) {
    return /* @__PURE__ */ jsx102(AlreadyPaddedRightContext.Provider, {
      value: true,
      children: content
    });
  }
...
import { useCallback as useCallback48, useMemo as useMemo58, useState as useState38 } from "react";
...
var InlineRemoveButton = ({ onClick }) => {
  const renderAction = useCallback47((color) => {
    return /* @__PURE__ */ jsx103("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 320 512",
      style: clearIcon,
      children: /* @__PURE__ */ jsx103("path", {
        d: "M310.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 210.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L114.7 256 9.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 301.3 265.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L205.3 256 310.6 150.6z",
        fill: color
      })
    });
  }, []);
  return /* @__PURE__ */ jsx103(InlineAction, {
    renderAction,
    onClick
  });
};
...
var defaultPropsEditorScrollableAreaRef = React67.createRef();
...
var SchemaLabel = ({
  ...
  const [clickableButtonHovered, setClickableButtonHovered] = useState38(false);
  const disableSave = saving || !valid || saveDisabledByParent;
  const labelStyle4 = useMemo58(() => {
    return {
      fontFamily: "monospace",
      fontSize: 14,
  ...
  const onClickablePointerEnter = useCallback48(() => {
    setClickableButtonHovered(true);
  }, []);
  const onClickablePointerLeave = useCallback48(() => {
    setClickableButtonHovered(false);
  }, []);
  const labelContent = /* @__PURE__ */ jsxs46("span", {
    style: labelStyle4,
    children: [
  ...
  return /* @__PURE__ */ jsxs46("div", {
    ...
    children: [
      handleClick ? /* @__PURE__ */ jsx104("button", {
      ...
      /* @__PURE__ */ jsx104(Flex, {}),
      isDefaultValue ? null : /* @__PURE__ */ jsx104(SchemaResetButton, {
        onClick: onReset
      }),
      isDefaultValue ? null : showSaveButton ? /* @__PURE__ */ jsx104(SchemaSaveButton, {
        onClick: onSave,
        disabled: disableSave
      }) : null,
      onRemove ? /* @__PURE__ */ jsx104(InlineRemoveButton, {
        onClick: onRemove
      }) : null
    ]
  });
...
import { useCallback as useCallback49, useMemo as useMemo59, useState as useState39 } from "react";
...
// src/components/RenderModal/SchemaEditor/SchemaSeparationLine.tsx
import { jsx as jsx106, jsxs as jsxs47, Fragment as Fragment18 } from "react/jsx-runtime";
...
var SchemaArrayItemSeparationLine = ({ onChange, index, schema, isLast, showAddButton }) => {
  const [outerHovered, setOuterHovered] = useState39(false);
  const [innerHovered, setInnerHovered] = useState39(false);
  ...
  const dynamicAddButtonStyle = useMemo59(() => {
    return {
      display: "flex",
      justifyContent: "center",
  ...
  const onOuterMouseEnter = useCallback49(() => {
    setOuterHovered(true);
  }, []);
  const onOuterMouseLeave = useCallback49(() => {
    setOuterHovered(false);
  }, []);
  const onInnerMouseEnter = useCallback49(() => {
    setInnerHovered(true);
  }, []);
  const onInnerMouseLeave = useCallback49(() => {
  ...
  return /* @__PURE__ */ jsxs47("div", {
    ...
    children: [
      ...
      isLast ? /* @__PURE__ */ jsxs47(Fragment18, {
        children: [
          /* @__PURE__ */ jsx106(Spacing, {
            x: 1
          }),
          /* @__PURE__ */ jsx106("div", {
            style: {
...
import React74, { useMemo as useMemo65, useState as useState42 } from "react";

// src/components/RenderModal/SchemaEditor/ZodArrayItemEditor.tsx
import { useCallback as useCallback50, useMemo as useMemo61 } from "react";
...
var ZodArrayItemEditor = ({
  ...
  const newJsonPath = useMemo61(() => [...jsonPath, index], [index, jsonPath]);
  const onSave = useCallback50((updater) => {
    onSaveObject((oldV) => [
      ...oldV.slice(0, index),
      updater(oldV[index]),
      ...oldV.slice(index + 1)
  ...
  return /* @__PURE__ */ jsx108("div", {
    children: /* @__PURE__ */ jsx108(ZodSwitch, {
...
import { useCallback as useCallback51, useEffect as useEffect38, useMemo as useMemo63, useRef as useRef23, useState as useState40 } from "react";
...
var InfoTooltip = ({ children, arrowDirection, backgroundColor }) => {
  ...
  return /* @__PURE__ */ jsxs49("div", {
    ...
    children: [
      ...
      arrowDirection === "down" ? /* @__PURE__ */ jsx109("svg", {
        viewBox: "0 0 14 7",
        style: arrowDown,
      ...
      arrowDirection === "up" ? /* @__PURE__ */ jsx109("svg", {
        viewBox: "0 0 14 7",
        style: arrowUp,
        children: /* @__PURE__ */ jsx109("path", {
...
// src/components/RenderModal/InfoBubble.tsx
import { jsx as jsx110, jsxs as jsxs50, Fragment as Fragment19 } from "react/jsx-runtime";
var icon4 = {
  color: LIGHT_TEXT,
  height: 15
};
...
var InfoBubble = ({ title: title3, children }) => {
  const [hovered, setIsHovered] = useState40(false);
  const [opened, setOpened] = useState40(false);
  ...
  return /* @__PURE__ */ jsxs50(Fragment19, {
    children: [
      ...
      portalStyle ? ReactDOM7.createPortal(/* @__PURE__ */ jsx110("div", {
        style: outerPortal,
        className: "css-reset",
        children: /* @__PURE__ */ jsx110(HigherZIndex, {
          onOutsideClick: onHide,
          onEscape: onHide,
          children: /* @__PURE__ */ jsx110("div", {
            style: portalStyle,
            children: /* @__PURE__ */ jsx110(InfoTooltip, {
              backgroundColor: INPUT_BACKGROUND,
...
var ZodFieldValidation = ({ localValue, path }) => {
  ...
  return /* @__PURE__ */ jsxs51("div", {
    style: legend,
    children: [
      /* @__PURE__ */ jsx111(ValidationMessage, {
        align: "flex-start",
        message: localValue.zodValidation.error.format()._errors[0],
        type: "error"
      }),
      /* @__PURE__ */ jsx111(Spacing, {
        x: 0.5
      }),
      /* @__PURE__ */ jsx111(InfoBubble, {
        ...
        children: /* @__PURE__ */ jsxs51("div", {
          ...
          children: [
            ...
            localValue.zodValidation.error.errors.map((error, index) => /* @__PURE__ */ jsxs51("div", {
              style: stackTraceLabel,
              children: [
                "Type: ",
                error.code,
...
var useLocalState = ({
  ...
  const [resetRevision, setResetRevision] = useState41(0);
  const [localValueOrNull, setLocalValue] = useState41(() => {
    return {
      [parentRevision]: {
        value: unsavedValue,
  ...
  const localUnsavedValue = useMemo64(() => {
  ...
  const currentLocalValue = useMemo64(() => {
  ...
  const onChange = useCallback52((updater, forceApply, increment) => {
  ...
  const reset = useCallback52(() => {
    onChange(() => savedValue, true, true);
    setResetRevision((old) => old + 1);
  }, [savedValue, onChange]);
  const RevisionContextProvider = useCallback52(({ children }) => {
    return /* @__PURE__ */ jsx112(RevisionContext.Provider, {
      value: contextValue,
      children
    });
  }, [contextValue]);
...
var ZodArrayEditor = ({
  ...
  const [expanded, setExpanded] = useState42(true);
  const def = schema._def;
  const suffix2 = useMemo65(() => {
    return expanded ? " [" : " [...] ";
  }, [expanded]);
  const z = useZodIfPossible();
  if (!z) {
  ...
  const isDefaultValue = useMemo65(() => {
    return deepEqual(localValue.value, defaultValue);
  }, [defaultValue, localValue]);
  return /* @__PURE__ */ jsxs52(Fieldset, {
    shouldPad: mayPad,
    ...
    children: [
      /* @__PURE__ */ jsx113("div", {
        ...
        children: /* @__PURE__ */ jsx113(SchemaLabel, {
          onReset: reset,
          isDefaultValue,
          jsonPath,
          onRemove,
      ...
      expanded ? /* @__PURE__ */ jsx113(RevisionContextProvider, {
        children: /* @__PURE__ */ jsxs52(SchemaVerticalGuide, {
          isRoot: false,
          children: [
            localValue.value.map((child, i) => {
              return /* @__PURE__ */ jsxs52(React74.Fragment, {
                children: [
                  /* @__PURE__ */ jsx113(ZodArrayItemEditor, {
                    onChange,
                    value: child,
                    def,
                    index: i,
                  ...
                  /* @__PURE__ */ jsx113(SchemaArrayItemSeparationLine, {
                    schema,
                    index: i,
                    onChange,
            ...
            value.length === 0 ? /* @__PURE__ */ jsx113(SchemaArrayItemSeparationLine, {
              schema,
              index: 0,
              onChange,
              isLast: true,
      ...
      /* @__PURE__ */ jsx113(ZodFieldValidation, {
        path: jsonPath,
        localValue
      })
    ]
...
var Checkbox = ({ checked, onChange, disabled, name }) => {
  ...
  return /* @__PURE__ */ jsxs53("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx114("div", {
        style: box,
        children: checked ? /* @__PURE__ */ jsx114(Checkmark, {}) : null
      })
    ]
  });
};
...
var ZodBooleanEditor = ({
  ...
  const onToggle = useCallback53((e) => {
  ...
  return /* @__PURE__ */ jsxs54(Fieldset, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx115("div", {
        style: fullWidth,
        children: /* @__PURE__ */ jsx115(Checkbox, {
          name: jsonPath.join("."),
...
import React77, { useCallback as useCallback54, useEffect as useEffect40, useMemo as useMemo67, useRef as useRef25, useState as useState43 } from "react";
...
var InputDraggerForwardRefFn = ({
  ...
  const [inputFallback, setInputFallback] = useState43(false);
  const fallbackRef = useRef25(null);
  const style8 = useMemo67(() => {
    return {
      ...inputBaseStyle,
      backgroundColor: "transparent",
  ...
  const onEscape = useCallback54(() => {
    setInputFallback(false);
  }, []);
  const onBlur = useCallback54(() => {
  ...
  const onKeyPress = useCallback54((e) => {
    if (e.key === "Enter") {
  ...
  const onPointerDown = useCallback54((e) => {
  ...
  if (inputFallback) {
    return /* @__PURE__ */ jsx116(HigherZIndex, {
      onEscape,
      onOutsideClick: noop,
      children: /* @__PURE__ */ jsx116(RemotionInput, {
        ref: fallbackRef,
        autoFocus: true,
        onKeyPress,
        onBlur,
  ...
  return /* @__PURE__ */ jsx116("button", {
    ...
    onClick,
    onPointerDown,
    children: /* @__PURE__ */ jsx116("span", {
      style: span,
      children: formatter(value)
    })
  });
};
var InputDragger = React77.forwardRef(InputDraggerForwardRefFn);
...
var ZodColorEditor = ({
  ...
  const onChange = useCallback55((e) => {
  ...
  const onTextChange = useCallback55((e) => {
  ...
  const onOpacityChange = useCallback55((newValue) => {
  ...
  const onOpacityValueChange = useCallback55((newValue) => {
    const newColor = colorWithNewOpacity(localValue.value, Math.round(Number(newValue) / 100 * 255), zodTypes);
    onValueChange(() => newColor, false, false);
  }, [localValue.value, onValueChange, zodTypes]);
        ...
        children: [
          /* @__PURE__ */ jsxs55(Row, {
            ...
            children: [
              /* @__PURE__ */ jsx118("div", {
                style: colorPicker,
                children: /* @__PURE__ */ jsx118(RemInputTypeColor, {
                  type: "color",
                  style: {
                    height: 39
                  },
              ...
              /* @__PURE__ */ jsx118(Spacing, {
                x: 1,
                block: true
              }),
              /* @__PURE__ */ jsx118(RemotionInput, {
...
import { jsx as jsx119, jsxs as jsxs56 } from "react/jsx-runtime";
var fullWidth3 = {
  width: "100%"
};
var explainer2 = {
...
var ZodDefaultEditor = ({
  ...
  return /* @__PURE__ */ jsx120(ZodSwitch, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
import { useCallback as useCallback57, useMemo as useMemo70 } from "react";
...
var ZodDiscriminatedUnionEditor = ({
  ...
  const options = useMemo70(() => [...typedSchema.optionsMap.keys()], [typedSchema.optionsMap]);
  const {
    localValue,
    onChange: setLocalValue,
    reset
  ...
  const comboBoxValues = useMemo70(() => {
    return options.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: option === value[typedSchema.discriminator] ? /* @__PURE__ */ jsx121(Checkmark, {}) : null,
        onClick: () => {
  ...
  const discriminatedUnionReplacement = useMemo70(() => {
    return {
      discriminator: typedSchema.discriminator,
      markup: /* @__PURE__ */ jsxs57(Fieldset, {
        shouldPad: mayPad,
        success: true,
        children: [
  ...
  return /* @__PURE__ */ jsx121(ZodObjectEditor, {
    jsonPath,
    mayPad,
    savedValue: defaultValue,
    onRemove,
...
var ZodEffectEditor = ({
  ...
  return /* @__PURE__ */ jsxs58(Fieldset, {
    ...
    children: [
      /* @__PURE__ */ jsx122("div", {
        style: fullWidth4,
        children: /* @__PURE__ */ jsx122(ZodSwitch, {
          value,
          setValue: onChange,
          jsonPath,
          schema: def.schema,
      ...
      /* @__PURE__ */ jsx122(ZodFieldValidation, {
        path: jsonPath,
        localValue
      })
    ]
  ...
  const comboBoxValues = useMemo71(() => {
    return def.values.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: option === value ? /* @__PURE__ */ jsx123(Checkmark, {}) : null,
        onClick: (id) => {
  ...
  return /* @__PURE__ */ jsxs59(Fieldset, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx123("div", {
        ...
        children: /* @__PURE__ */ jsx123(Combobox, {
          values: comboBoxValues,
          selectedId: value,
          title: value
        })
...
import React82, { useMemo as useMemo72, useState as useState45 } from "react";
...
var ZodMatrixEditor = ({
  ...
  const [expanded, setExpanded] = useState45(true);
  const def = schema._def;
  ...
  return /* @__PURE__ */ jsxs60(Fieldset, {
    ...
    children: [
      ...
      expanded ? /* @__PURE__ */ jsx124(RevisionContextProvider, {
        children: /* @__PURE__ */ jsxs60(SchemaVerticalGuide, {
          isRoot: false,
          children: [
            chunkedItems.map((row3, rowIndex) => {
              return /* @__PURE__ */ jsx124(React82.Fragment, {
                children: /* @__PURE__ */ jsx124("div", {
                  style: rowStyle,
                  children: row3.map((item2, _index) => {
                    const actualIndex = rowIndex * dimensions + _index;
                    return /* @__PURE__ */ jsx124("div", {
                      style: { flex: 1 },
                      children: /* @__PURE__ */ jsx124(ZodArrayItemEditor, {
                        onChange,
                        value: item2,
                        def,
                        index: actualIndex,
            ...
            value.length === 0 ? /* @__PURE__ */ jsx124(SchemaArrayItemSeparationLine, {
              schema,
              index: 0,
              onChange,
              isLast: true,
...
var ZodOrNullishEditor = ({
  ...
  const onCheckBoxChange = useCallback60((e) => {
  ...
  return /* @__PURE__ */ jsxs62(Fieldset, {
    ...
    success: localValue.zodValidation.success,
    children: [
      localValue.value === nullishValue ? /* @__PURE__ */ jsx126(SchemaLabel, {
        handleClick: null,
        isDefaultValue: localValue.value === defaultValue,
        jsonPath,
        onReset: reset,
      ...
      /* @__PURE__ */ jsxs62("div", {
        ...
        children: [
          /* @__PURE__ */ jsx126(Checkbox, {
            checked: isChecked,
            onChange: onCheckBoxChange,
            disabled: false,
            name: jsonPath.join(".")
          }),
          /* @__PURE__ */ jsx126(Spacing, {
            x: 1
          }),
          /* @__PURE__ */ jsx126("div", {
            style: labelStyle4,
...
var ZodNullableEditor = ({
  ...
  const { innerType } = schema._def;
  return /* @__PURE__ */ jsx127(ZodOrNullishEditor, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
import { jsx as jsx128, jsxs as jsxs63 } from "react/jsx-runtime";
var fullWidth6 = {
  width: "100%"
};
...
var ZodNumberEditor = ({
  ...
  const onNumberChange = useCallback61((newValue) => {
    setLocalValue(() => newValue, false, false);
  }, [setLocalValue]);
  const isDefault = localValue.value === defaultValue;
  const onTextChange = useCallback61((newValue) => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs63("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx128(ZodFieldValidation, {
            path: jsonPath,
            localValue
          })
        ]
...
import { useCallback as useCallback62, useMemo as useMemo73 } from "react";
import { jsx as jsx130, jsxs as jsxs64 } from "react/jsx-runtime";
var container29 = {
  width: "100%"
};
  ...
  const comboBoxValues = useMemo73(() => {
    return getStaticFiles().map((option) => {
      return {
        ...
        id: option.src,
        keyHint: null,
        leftItem: option.src === value ? /* @__PURE__ */ jsx130(Checkmark, {}) : null,
        onClick: (id) => {
          setLocalValue(() => id, false, false);
        },
        quickSwitcherLabel: null,
  ...
  return /* @__PURE__ */ jsxs64(Fieldset, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx130("div", {
        ...
        children: /* @__PURE__ */ jsx130(Combobox, {
          values: comboBoxValues,
...
import { jsx as jsx131, jsxs as jsxs65 } from "react/jsx-runtime";
var fullWidth7 = {
  width: "100%"
};
var ZodStringEditor = ({
  ...
  const onChange = useCallback63((e) => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs65("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx131(ZodFieldValidation, {
            path: jsonPath,
            localValue
          })
        ]
...
import React88, { useMemo as useMemo75, useState as useState46 } from "react";

// src/components/RenderModal/SchemaEditor/ZodTupleItemEditor.tsx
import { useCallback as useCallback65, useMemo as useMemo74 } from "react";
...
var ZodTupleItemEditor = ({
  ...
  const setValue = useCallback65((val) => {
    onChange((oldV) => [
      ...oldV.slice(0, index),
      typeof val === "function" ? val(oldV[index]) : val,
      ...oldV.slice(index + 1)
  ...
  const newJsonPath = useMemo74(() => [...jsonPath, index], [index, jsonPath]);
  ...
  return /* @__PURE__ */ jsx133("div", {
    children: /* @__PURE__ */ jsx133(ZodSwitch, {
      jsonPath: newJsonPath,
...
var ZodTupleEditor = ({
  ...
  const isDefaultValue = useMemo75(() => {
    return deepEqual(localValue.value, defaultValue);
  }, [defaultValue, localValue]);
  return /* @__PURE__ */ jsxs67(Fieldset, {
    ...
    children: [
      /* @__PURE__ */ jsx134("div", {
        ...
        children: /* @__PURE__ */ jsx134(SchemaLabel, {
          onReset: reset,
          isDefaultValue,
          jsonPath,
          onRemove,
      ...
      expanded ? /* @__PURE__ */ jsx134(RevisionContextProvider, {
        children: /* @__PURE__ */ jsxs67(SchemaVerticalGuide, {
          isRoot: false,
          children: [
            localValue.value.map((child, i) => {
              return /* @__PURE__ */ jsxs67(React88.Fragment, {
                children: [
                  /* @__PURE__ */ jsx134(ZodTupleItemEditor, {
                    onChange,
                    value: child,
                    def,
                    index: i,
                  ...
                  /* @__PURE__ */ jsx134(SchemaArrayItemSeparationLine, {
                    schema,
                    index: i,
                    onChange,
                    isLast: i === localValue.value.length - 1,
            ...
            value.length === 0 ? /* @__PURE__ */ jsx134(SchemaArrayItemSeparationLine, {
              schema,
              index: 0,
              onChange,
              isLast: true,
...
var ZodUnionEditor = ({
  ...
  if (options.length > 2) {
    return /* @__PURE__ */ jsx135(ZonNonEditableValue, {
      jsonPath,
  ...
  return /* @__PURE__ */ jsx135(ZodOrNullishEditor, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
var ZodSwitch = ({
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodObject) {
    return /* @__PURE__ */ jsx136(ZodObjectEditor, {
      setValue,
      unsavedValue: value,
      savedValue: defaultValue,
      jsonPath,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodString) {
    if (value.startsWith(window.remotion_staticBase)) {
      return /* @__PURE__ */ jsx136(ZodStaticFileEditor, {
        setValue,
        value,
        jsonPath,
        schema,
    ...
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_TEXTAREA_BRAND) {
      return /* @__PURE__ */ jsx136(ZodTextareaEditor, {
        value,
        setValue,
        jsonPath,
        schema,
    ...
    return /* @__PURE__ */ jsx136(ZodStringEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDate) {
    return /* @__PURE__ */ jsx136(ZodDateEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNumber) {
    return /* @__PURE__ */ jsx136(ZodNumberEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodBoolean) {
    return /* @__PURE__ */ jsx136(ZodBooleanEditor, {
      value,
      setValue,
      jsonPath,
      defaultValue,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodUndefined) {
    return /* @__PURE__ */ jsx136(ZonNonEditableValue, {
      jsonPath,
      showSaveButton,
      label: "undefined",
      saving,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodArray) {
    return /* @__PURE__ */ jsx136(ZodArrayEditor, {
      setValue,
      value,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodEnum) {
    return /* @__PURE__ */ jsx136(ZodEnumEditor, {
      setValue,
      value,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodEffects) {
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_COLOR_BRAND) {
      return /* @__PURE__ */ jsx136(ZodColorEditor, {
        value,
        setValue,
        jsonPath,
        schema,
    ...
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_MATRIX_BRAND) {
      return /* @__PURE__ */ jsx136(ZodMatrixEditor, {
        setValue,
        value,
        jsonPath,
    ...
    return /* @__PURE__ */ jsx136(ZodEffectEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodUnion) {
    return /* @__PURE__ */ jsx136(ZodUnionEditor, {
      schema,
      showSaveButton,
      jsonPath,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodOptional) {
    return /* @__PURE__ */ jsx136(ZodOptionalEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNullable) {
    return /* @__PURE__ */ jsx136(ZodNullableEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDefault) {
    return /* @__PURE__ */ jsx136(ZodDefaultEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDiscriminatedUnion) {
    return /* @__PURE__ */ jsx136(ZodDiscriminatedUnionEditor, {
      defaultValue,
      mayPad,
      schema,
      setValue,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodTuple) {
    return /* @__PURE__ */ jsx136(ZodTupleEditor, {
      setValue,
      value,
      jsonPath,
      schema,
...
// src/components/RenderModal/SchemaEditor/ZodObjectEditor.tsx
import { jsx as jsx137, jsxs as jsxs68 } from "react/jsx-runtime";
var ZodObjectEditor = ({
  schema,
  jsonPath,
  setValue,
  ...
  return /* @__PURE__ */ jsxs68(Fieldset, {
    ...
    success: localValue.zodValidation.success,
    children: [
      isRoot ? null : /* @__PURE__ */ jsx137(SchemaLabel, {
        isDefaultValue,
        onReset: reset,
        jsonPath,
        onRemove,
      ...
      expanded ? /* @__PURE__ */ jsx137(RevisionContextProvider, {
        children: /* @__PURE__ */ jsx137(SchemaVerticalGuide, {
          isRoot,
          children: keys.map((key, i) => {
            ...
            return /* @__PURE__ */ jsxs68(React89.Fragment, {
              children: [
                /* @__PURE__ */ jsx137(ZodSwitch, {
                  mayPad: true,
                ...
                i === keys.length - 1 ? null : /* @__PURE__ */ jsx137(SchemaSeparationLine, {})
              ]
            }, key);
          })
        })
      }) : null,
      isRoot || !expanded ? null : /* @__PURE__ */ jsx137("div", {
        style: fieldsetLabel,
        children: "}"
      })
    ]
...
var SchemaEditor = ({
  ...
  const keybindings = useKeybinding();
  const [revision, setRevision] = useState48(0);
  const revisionState = useMemo77(() => {
    return {
  ...
  if (!zodValidationResult.success) {
    ...
    if (!defaultPropsValid.success) {
      return /* @__PURE__ */ jsx138(InvalidDefaultProps, {
        zodValidationResult
      });
    }
    return /* @__PURE__ */ jsx138(InvalidSchema, {
      reset,
      zodValidationResult
    });
  }
  if (typeName !== z.ZodFirstPartyTypeKind.ZodObject) {
    return /* @__PURE__ */ jsx138(TopLevelZodValue, {
  ...
  return /* @__PURE__ */ jsx138("div", {
    ...
    style: scrollable2,
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: /* @__PURE__ */ jsx138(RevisionContext.Provider, {
      value: revisionState,
      children: /* @__PURE__ */ jsx138(ZodObjectEditor, {
        discriminatedUnionReplacement: null,
...
import { useCallback as useCallback67, useMemo as useMemo78 } from "react";
...
var WarningIndicatorButton = ({ setShowWarning, showWarning, warningCount }) => {
  ...
  return /* @__PURE__ */ jsxs69("button", {
    type: "button",
    style: buttonStyle3,
    onClick,
    children: [
      /* @__PURE__ */ jsx139(WarningTriangle2, {
        style: triangleStyle2
      }),
      /* @__PURE__ */ jsx139(Spacing, {
        x: 0.5
      }),
      warningCount,
      /* @__PURE__ */ jsx139(Spacing, {
...
var DataEditor = ({
  ...
  const [mode, setMode] = useState49("schema");
  const [showWarning, setShowWarningWithoutPersistance] = useState49(() => getPersistedShowWarningState());
  const { updateCompositionDefaultProps } = useContext36(Internals31.CompositionSetters);
  const inJSONEditor = mode === "json";
  const serializedJSON = useMemo79(() => {
    if (!inJSONEditor) {
      return null;
    }
  ...
  const [canSaveDefaultPropsObjectState, setCanSaveDefaultProps] = useState49({
  ...
  const zodValidationResult = useMemo79(() => {
    if (schema === "no-zod") {
      return "no-zod";
    }
    if (schema === "no-schema") {
  ...
  const setShowWarning = useCallback68((val) => {
  ...
  const canSaveDefaultProps = useMemo79(() => {
  ...
  const checkIfCanSaveDefaultProps = useCallback68(async () => {
    try {
  ...
  const onSave = useCallback68((updater) => {
    if (schema === "no-zod" || schema === "no-schema" || z === null) {
      showNotification("Cannot update default props: No Zod schema", 2000);
      return;
    }
  ...
  if (schema === "no-zod") {
    return /* @__PURE__ */ jsx140(ZodNotInstalled, {});
  }
  if (schema === "no-schema") {
    return /* @__PURE__ */ jsx140(NoSchemaDefined, {});
  }
  if (!z) {
    throw new Error("expected zod");
  }
  ...
  if (!unresolvedComposition.defaultProps) {
    return /* @__PURE__ */ jsx140(NoDefaultProps, {});
  }
  return /* @__PURE__ */ jsxs70("div", {
    style: outer,
    children: [
      /* @__PURE__ */ jsxs70("div", {
        ...
        children: [
          /* @__PURE__ */ jsxs70("div", {
            style: tabWrapper,
            children: [
              /* @__PURE__ */ jsx140(SegmentedControl, {
                items: modeItems,
                needsWrapping: false
              }),
              /* @__PURE__ */ jsx140(Flex, {}),
              warnings.length > 0 ? /* @__PURE__ */ jsx140(WarningIndicatorButton, {
                setShowWarning,
                showWarning,
          ...
          showWarning && warnings.length > 0 ? warnings.map((warning) => /* @__PURE__ */ jsxs70(React92.Fragment, {
            children: [
              /* @__PURE__ */ jsx140(Spacing, {
                y: 1
              }),
              /* @__PURE__ */ jsx140(ValidationMessage, {
                message: warning,
                align: "flex-start",
                type: "warning"
              })
      ...
      mode === "schema" ? /* @__PURE__ */ jsx140(SchemaEditor, {
      ...
      }) : /* @__PURE__ */ jsx140(RenderModalJSONPropsEditor, {
        value: defaultProps ?? {},
        setValue: setDefaultProps,
        onSave: onUpdate,
        showSaveButton,
...
import React102, { useContext as useContext42, useEffect as useEffect45, useMemo as useMemo86 } from "react";
...
var RenderQueueCopyToClipboard = ({ job }) => {
  const renderCopyAction = useCallback69((color) => {
    return /* @__PURE__ */ jsx141(ClipboardIcon, {
      style: revealIconStyle2,
      color
    });
  }, []);
  const onClick = useCallback69(async (e) => {
    e.stopPropagation();
    try {
...
import { useCallback as useCallback70, useContext as useContext37 } from "react";
...
import { useCallback as useCallback71, useMemo as useMemo80 } from "react";
...
var RenderQueueCancelButton = ({ job }) => {
  ...
  const icon5 = useMemo80(() => {
    return {
      height: 14,
      color: "currentColor"
    };
  }, []);
  const renderAction = useCallback71((color) => {
    return /* @__PURE__ */ jsx143("svg", {
      style: icon5,
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 512 512",
      children: /* @__PURE__ */ jsx143("path", {
        fill: color,
  ...
  return /* @__PURE__ */ jsx143(InlineAction, {
    renderAction,
    onClick
  });
};
...
import React95, { useCallback as useCallback72, useContext as useContext38 } from "react";
...
var CircularProgress = ({ progress }) => {
  ...
  return /* @__PURE__ */ jsx144("svg", {
    ...
    children: /* @__PURE__ */ jsx144("circle", {
...
var RenderQueueItemStatus = ({ job }) => {
  ...
  const [hovered, setHovered] = React95.useState(false);
  const onPointerEnter = useCallback72(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback72(() => {
    setHovered(false);
  }, []);
  ...
  if (job.status === "running") {
    return /* @__PURE__ */ jsx145("button", {
      ...
      style: invisibleStyle,
      onClick,
      children: /* @__PURE__ */ jsx145(CircularProgress, {
...
import { useCallback as useCallback73, useMemo as useMemo81 } from "react";
...
var RenderQueueOpenInFinderItem = ({ job }) => {
  ...
  const renderAction = useCallback73((color) => {
    return /* @__PURE__ */ jsx146(ExpandedFolderIconSolid, {
      style: icon5,
      color
    });
  }, [icon5]);
...
import { useCallback as useCallback74, useContext as useContext39 } from "react";
...
import { useCallback as useCallback75, useMemo as useMemo83 } from "react";
import { jsx as jsx149 } from "react/jsx-runtime";
var RenderQueueRemoveItem = ({ job }) => {
  const onClick = useCallback75((e) => {
    e.stopPropagation();
  ...
  const icon5 = useMemo83(() => {
    return {
      height: 16,
      color: "currentColor"
    };
  }, []);
  const renderAction = useCallback75((color) => {
...
import { useCallback as useCallback76, useContext as useContext40, useMemo as useMemo84 } from "react";
...
var RenderQueueRepeatItem = ({ job }) => {
  ...
  const isMobileLayout = useMobileLayout();
  const { setSidebarCollapsedState } = useContext40(SidebarContext);
  ...
  return /* @__PURE__ */ jsx150(InlineAction, {
    onClick,
    renderAction
  });
};
...
var RenderQueueItem = ({ job, selected }) => {
  ...
  const onPointerEnter = useCallback77(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback77(() => {
    setHovered(false);
  }, []);
  const isHoverable = job.status === "done";
  const containerStyle2 = useMemo85(() => {
    return {
      ...container31,
      backgroundColor: getBackgroundFromHoverState({
  ...
  const scrollCurrentIntoView = useCallback77(() => {
  ...
  return /* @__PURE__ */ jsxs71(Row, {
    ...
    children: [
      /* @__PURE__ */ jsx151(RenderQueueItemStatus, {
        job
      }),
      /* @__PURE__ */ jsx151(Spacing, {
        x: 1
      }),
      /* @__PURE__ */ jsxs71("div", {
        style: right,
        children: [
          ...
          /* @__PURE__ */ jsx151("div", {
            style: subtitle2,
            children: job.status === "done" ? /* @__PURE__ */ jsx151(RenderQueueOutputName, {
              job
            }) : job.status === "failed" ? /* @__PURE__ */ jsx151(RenderQueueError, {
              job
            }) : job.status === "running" ? /* @__PURE__ */ jsx151(RenderQueueProgressMessage, {
              job
            }) : null
          })
        ]
      ...
      supportsCopyingToClipboard(job) ? /* @__PURE__ */ jsx151(RenderQueueCopyToClipboard, {
        job
      }) : null,
      job.status === "done" || job.status === "failed" ? /* @__PURE__ */ jsx151(RenderQueueRepeatItem, {
        job
      }) : null,
      job.status === "running" ? /* @__PURE__ */ jsx151(RenderQueueCancelButton, {
        job
      }) : /* @__PURE__ */ jsx151(RenderQueueRemoveItem, {
        job
      }),
      job.status === "done" ? /* @__PURE__ */ jsx151(RenderQueueOpenInFinderItem, {
        job
      }) : null
    ]
  });
...
var RenderQueue = () => {
  ...
  const { jobs } = useContext42(RenderQueueContext);
  const { canvasContent } = useContext42(Internals33.CompositionManager);
  const previousJobCount = React102.useRef(jobs.length);
  const jobCount = jobs.length;
  const divRef = React102.useRef(null);
  useEffect45(() => {
    if (!divRef.current) {
      return;
    }
  ...
  return /* @__PURE__ */ jsx152("div", {
    ...
    children: jobs.map((j, index) => {
      return /* @__PURE__ */ jsx152("div", {
        ...
        children: /* @__PURE__ */ jsx152(RenderQueueItem, {
...
import { useContext as useContext43, useMemo as useMemo87 } from "react";
import { Internals as Internals34 } from "remotion";
import { jsx as jsx153, jsxs as jsxs73, Fragment as Fragment20 } from "react/jsx-runtime";
var row3 = {
  display: "flex",
  flexDirection: "row",
  fontSize: 14,
...
var RendersTab = ({ selected, onClick }) => {
  const { jobs } = useContext43(RenderQueueContext);
  const { canvasContent } = useContext43(Internals34.CompositionManager);
  const failedJobs = jobs.filter((j) => j.status === "failed").length;
  const jobCount = jobs.length;
  const isActuallySelected = useMemo87(() => {
    if (!canvasContent || canvasContent.type !== "composition") {
      return true;
    }
    return selected;
  }, [canvasContent, selected]);
  const badgeStyle = useMemo87(() => {
    return {
      ...badge,
  ...
  return /* @__PURE__ */ jsx153(Tab, {
    ...
    children: /* @__PURE__ */ jsxs73("div", {
      ...
      children: [
        "Renders",
        jobCount > 0 ? /* @__PURE__ */ jsxs73(Fragment20, {
          children: [
            /* @__PURE__ */ jsx153(Flex, {}),
            /* @__PURE__ */ jsx153("div", {
              style: badgeStyle,
              children: jobCount
            })
...
import React105, { useContext as useContext45 } from "react";

// src/components/VisualControls/VisualControlHandle.tsx
import { useCallback as useCallback79, useContext as useContext44, useEffect as useEffect47, useState as useState53 } from "react";
...
import { useCallback as useCallback78, useMemo as useMemo88, useState as useState51 } from "react";
...
var ClickableFileName = ({
  ...
  const [titleHovered, setTitleHovered] = useState51(false);
  const hoverEffect = titleHovered && originalFileName.type === "loaded";
  const onTitlePointerEnter = useCallback78(() => {
    setTitleHovered(true);
  }, []);
  const onTitlePointerLeave = useCallback78(() => {
    setTitleHovered(false);
  }, []);
  const style9 = useMemo88(() => {
    return {
      fontSize: 12,
  ...
  const onClick = useCallback78(async () => {
...
var VisualControlHandleHeader = ({ originalFileName }) => {
  return /* @__PURE__ */ jsx155(ClickableFileName, {
    originalFileName
  });
};
...
var useOriginalFileName = (stack2) => {
  const [originalFileName, setOriginalFileName] = useState52({ type: "loading" });
  useEffect46(() => {
    if (!stack2) {
      return;
    }
...
// src/components/VisualControls/VisualControlHandle.tsx
import { jsx as jsx156, jsxs as jsxs74, Fragment as Fragment21 } from "react/jsx-runtime";
var VisualControlHandle = ({ value, keyName }) => {
  ...
  const zodTypes = useZodTypesIfPossible();
  const state = useContext44(VisualControlsContext);
  const { updateValue } = useContext44(SetVisualControlsContext);
  const { fastRefreshes } = useContext44(Internals35.NonceContext);
  const { increaseManualRefreshes } = useContext44(Internals35.SetNonceContext);
  ...
  const onSave = useCallback79((updater) => {
    if (disableSave) {
      return;
    }
    if (originalFileName.type !== "loaded") {
  ...
  return /* @__PURE__ */ jsxs74(Fragment21, {
    children: [
      /* @__PURE__ */ jsx156(VisualControlHandleHeader, {
        originalFileName
      }),
      /* @__PURE__ */ jsx156(Spacing, {
        block: true,
        y: 0.5
      }),
      /* @__PURE__ */ jsx156(RevisionContextProvider, {
        children: /* @__PURE__ */ jsx156(ZodSwitch, {
          mayPad: true,
          schema: value.schema,
...
// src/components/VisualControls/VisualControlsContent.tsx
import { jsx as jsx157, jsxs as jsxs75 } from "react/jsx-runtime";
var container33 = {
  overflowY: "auto"
};
var VisualControlsContent = () => {
  const { handles } = useContext45(VisualControlsContext);
  const entries = Object.entries(handles);
  return /* @__PURE__ */ jsx157("div", {
    style: container33,
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: entries.map(([key, value], i) => {
      return /* @__PURE__ */ jsxs75(React105.Fragment, {
        children: [
          /* @__PURE__ */ jsx157(VisualControlHandle, {
            keyName: key,
            value
          }),
          i === entries.length - 1 ? null : /* @__PURE__ */ jsx157(SchemaSeparationLine, {})
        ]
      }, key);
    })
  });
...
var OptionsPanel = ({ readOnlyStudio }) => {
  const { props, updateProps, resetUnsaved } = useContext46(Internals36.EditorPropsContext);
  const [saving, setSaving] = useState54(false);
  const isMobileLayout = useMobileLayout();
  const visualControlsTabActivated = useContext46(VisualControlsTabActivatedContext);
  const container34 = useMemo89(() => ({
    height: "100%",
    width: "100%",
    display: "flex",
  ...
  const [panel2, setPanel] = useState54(() => getSelectedPanel2(readOnlyStudio));
  const onPropsSelected = useCallback80(() => {
    setPanel("input-props");
    persistSelectedOptionsSidebarPanel2("input-props");
  }, []);
  const onRendersSelected = useCallback80(() => {
    setPanel("renders");
    persistSelectedOptionsSidebarPanel2("renders");
  }, []);
  const onVisualControlsSelected = useCallback80(() => {
  ...
  const { compositions, canvasContent } = useContext46(Internals36.CompositionManager);
  const composition = useMemo89(() => {
    if (canvasContent === null || canvasContent.type !== "composition") {
      return null;
    }
  ...
  const setDefaultProps = useCallback80((newProps) => {
    if (composition === null) {
      return;
    }
    window.remotion_ignoreFastRefreshUpdate = null;
  ...
  const currentDefaultProps = useMemo89(() => {
    if (composition === null) {
      return {};
    }
    return props[composition.id] ?? composition.defaultProps ?? {};
  }, [composition, props]);
  const unsavedChangesExist = useMemo89(() => {
    ...
    children: [
      /* @__PURE__ */ jsx158("div", {
        ...
        children: /* @__PURE__ */ jsxs76(Tabs, {
          children: [
            visualControlsTabActivated ? /* @__PURE__ */ jsx158(Tab, {
              selected: panel2 === "visual-controls",
              onClick: onVisualControlsSelected,
              children: "Controls"
            }) : null,
            composition ? /* @__PURE__ */ jsxs76(Tab, {
              selected: panel2 === "input-props",
              onClick: onPropsSelected,
              style: { justifyContent: "space-between" },
              children: [
                "Props",
                unsavedChangesExist ? /* @__PURE__ */ jsx158(GlobalPropsEditorUpdateButton, {
                  compositionId: composition.id,
                  currentDefaultProps
                }) : null
              ]
            }) : null,
            readOnlyStudio ? null : /* @__PURE__ */ jsx158(RendersTab, {
      ...
      panel2 === `input-props` && composition ? /* @__PURE__ */ jsx158(DataEditor, {
        ...
        setSaving,
        readOnlyStudio
      }, composition.id) : panel2 === "visual-controls" && visualControlsTabActivated ? /* @__PURE__ */ jsx158(VisualControlsContent, {}) : readOnlyStudio ? null : /* @__PURE__ */ jsx158(RenderQueue, {})
    ]
  });
};

// src/components/PreviewToolbar.tsx
import { useContext as useContext53, useEffect as useEffect54, useRef as useRef28, useState as useState57 } from "react";
...
var CheckboardToggle = () => {
  const { checkerboard, setCheckerboard } = useContext47(CheckerboardContext);
  const onClick = useCallback81(() => {
    setCheckerboard((c) => {
      return !c;
    });
  }, [setCheckerboard]);
  return /* @__PURE__ */ jsx159(ControlButton, {
    title: accessibilityLabel2,
    "aria-label": accessibilityLabel2,
    onClick,
    children: /* @__PURE__ */ jsx159("svg", {
      "aria-hidden": "true",
      focusable: "false",
      "data-prefix": "fas",
...
var FpsCounter = ({ playbackSpeed }) => {
  ...
  const [marker, rerender] = useState55({});
  const [fps, setFps] = useState55(0);
  const previousUpdates = useRef27([]);
  const fpsRef = useRef27(0);
  const playingRef = useRef27(playing);
  useLayoutEffect(() => {
    fpsRef.current = 0;
...
import { useCallback as useCallback82, useContext as useContext48, useEffect as useEffect50 } from "react";
...
var FullScreenToggle = () => {
  const keybindings = useKeybinding();
  const { setSize } = useContext48(Internals38.PreviewSizeContext);
  ...
  return /* @__PURE__ */ jsx160(ControlButton, {
    title: accessibilityLabel3,
    "aria-label": accessibilityLabel3,
    onClick,
    children: /* @__PURE__ */ jsx160("svg", {
...
var LoopToggle = ({ loop, setLoop }) => {
  ...
  return /* @__PURE__ */ jsx161(ControlButton, {
    title: accessibilityLabel4,
    "aria-label": accessibilityLabel4,
    onClick,
    children: /* @__PURE__ */ jsx161("svg", {
      viewBox: "0 0 512 512",
      style: { width: 18, height: 18 },
...
var MuteToggle = ({ muted, setMuted }) => {
  ...
  return /* @__PURE__ */ jsx163(ControlButton, {
    ...
    onClick,
    children: muted ? /* @__PURE__ */ jsx163(VolumeOffIcon, {}) : /* @__PURE__ */ jsx163(VolumeOnIcon, {})
  });
};

// src/components/PlayPause.tsx
import { PlayerInternals as PlayerInternals12 } from "@remotion/player";
import { useCallback as useCallback85, useEffect as useEffect51, useState as useState56 } from "react";
...
var Pause = (props) => /* @__PURE__ */ jsx165("svg", {
  ...props,
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "fas",
...
var Play = (props) => /* @__PURE__ */ jsx166("svg", {
  ...props,
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "fas",
...
// src/components/PlayPause.tsx
import { jsx as jsx169, jsxs as jsxs78, Fragment as Fragment22 } from "react/jsx-runtime";
var backStyle = {
  height: 18,
  color: "white"
};
...
var PlayPause = ({ playbackRate, loop, bufferStateDelayInMilliseconds }) => {
  ...
  const [showBufferIndicator, setShowBufferState] = useState56(false);
  const {
    playing,
    play,
    pause,
  ...
  const onEnter = useCallback85((e) => {
    if (playing) {
      e.preventDefault();
      pauseAndReturnToPlayStart();
    }
  }, [pauseAndReturnToPlayStart, playing]);
  const onArrowLeft = useCallback85((e) => {
    e.preventDefault();
    if (e.altKey) {
      seek(0);
      ensureFrameIsInViewport({
  ...
  const onArrowRight = useCallback85((e) => {
    if (e.altKey) {
  ...
  const oneFrameBack = useCallback85(() => {
    frameBack(1);
  }, [frameBack]);
  const oneFrameForward = useCallback85(() => {
    frameForward(1);
  }, [frameForward]);
  const jumpToStart = useCallback85(() => {
    seek(inFrame ?? 0);
  }, [seek, inFrame]);
  const jumpToEnd = useCallback85(() => {
  ...
  return /* @__PURE__ */ jsxs78(Fragment22, {
    children: [
      /* @__PURE__ */ jsx169(ControlButton, {
        "aria-label": "Jump to beginning",
        title: "Jump to beginning",
        disabled: !videoConfig || isFirstFrame,
        onClick: jumpToStart,
        children: /* @__PURE__ */ jsx169(JumpToStart, {
          style: backStyle
        })
      }),
      /* @__PURE__ */ jsx169(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx169(StepBack, {
      ...
      /* @__PURE__ */ jsx169(ControlButton, {
        ...
        children: playing ? showBufferIndicator ? /* @__PURE__ */ jsx169(PlayerInternals12.BufferingIndicator, {
          type: "studio"
        }) : /* @__PURE__ */ jsx169(Pause, {
          style: iconButton
        }) : /* @__PURE__ */ jsx169(Play, {
          style: iconButton
        })
      }),
      /* @__PURE__ */ jsx169(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx169(StepForward, {
          style: forwardBackStyle
        })
      })
    ]
...
var PlaybackKeyboardShortcutsManager = ({ setPlaybackRate }) => {
  ...
  const onKKey = useCallback86(() => {
    setPlaybackRate(1);
    pause();
  }, [pause, setPlaybackRate]);
  const onLKey = useCallback86(() => {
    setPlaybackRate((prevPlaybackRate) => {
      if (!playing) {
        return 1;
      }
...
import { useContext as useContext49, useEffect as useEffect53 } from "react";
...
import { useContext as useContext50, useMemo as useMemo91 } from "react";
...
var PlaybackRateSelector = ({ playbackRate, setPlaybackRate }) => {
  const { canvasContent } = useContext50(Internals41.CompositionManager);
  const isStill = useIsStill();
  ...
  const items = useMemo91(() => {
    ...
    const values = commonPlaybackRates.map((newPlaybackRate) => {
      return {
        ...
        keyHint: null,
        leftItem: String(playbackRate) === String(newPlaybackRate) ? /* @__PURE__ */ jsx170(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null
      };
    });
  ...
  return /* @__PURE__ */ jsx170("div", {
    style: style9,
    "aria-label": accessibilityLabel5,
    children: /* @__PURE__ */ jsx170(Combobox, {
      title: accessibilityLabel5,
      style: comboStyle2,
...
import { useCallback as useCallback87, useContext as useContext51, useMemo as useMemo92 } from "react";
import { Internals as Internals42 } from "remotion";
import { jsx as jsx171, jsxs as jsxs79 } from "react/jsx-runtime";
var button3 = {
  paddingLeft: 7,
  paddingRight: 7,
  paddingTop: 7,
...
var RenderButton = () => {
  ...
  const { props } = useContext51(Internals42.EditorPropsContext);
  ...
  return /* @__PURE__ */ jsx171(Button, {
    ...
    children: /* @__PURE__ */ jsxs79(Row, {
      align: "center",
      children: [
        /* @__PURE__ */ jsx171(RenderIcon, {
          svgProps: iconStyle4
        }),
        /* @__PURE__ */ jsx171(Spacing, {
          x: 1
        }),
        /* @__PURE__ */ jsx171("span", {
          style: label7,
          children: "Render"
        })
      ]
...
import { useCallback as useCallback88, useContext as useContext52 } from "react";
...
// src/components/Timeline/TimelineZoomControls.tsx
import { jsx as jsx173, jsxs as jsxs80 } from "react/jsx-runtime";
var container34 = {
  color: "black",
  flexDirection: "row",
  display: "flex",
...
var TimelineZoomControls = () => {
  const { canvasContent } = useContext52(Internals43.CompositionManager);
  const { setZoom, zoom: zoomMap } = useContext52(TimelineZoomCtx);
  const { tabIndex } = useZIndex();
  const onMinusClicked = useCallback88(() => {
    if (canvasContent === null || canvasContent.type !== "composition") {
      return;
    }
    setZoom(canvasContent.compositionId, (z) => Math.max(TIMELINE_MIN_ZOOM, z - 0.2));
  }, [canvasContent, setZoom]);
  const onPlusClicked = useCallback88(() => {
    if (canvasContent === null || canvasContent.type !== "composition") {
      return;
    }
    setZoom(canvasContent.compositionId, (z) => Math.min(TIMELINE_MAX_ZOOM, z + 0.2));
  }, [canvasContent, setZoom]);
  const onChange = useCallback88((e) => {
    if (canvasContent === null || canvasContent.type !== "composition") {
      return;
    }
  ...
  return /* @__PURE__ */ jsxs80("div", {
    ...
    children: [
      /* @__PURE__ */ jsx173(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx173(Minus, {
          style: iconStyle4
        })
      }),
      /* @__PURE__ */ jsx173(Spacing, {
        x: 0.5
      }),
      /* @__PURE__ */ jsx173("input", {
...
var PreviewToolbar = ({ readOnlyStudio, bufferStateDelayInMilliseconds }) => {
  const { playbackRate, setPlaybackRate } = useContext53(Internals44.Timeline.TimelineContext);
  ...
  const previewToolbarRef = useRef28(null);
  const leftScrollIndicatorRef = useRef28(null);
  const rightScrollIndicatorRef = useRef28(null);
  const isStill = useIsStill();
  const [loop, setLoop] = useState57(loadLoopOption());
  const isFullscreenSupported = checkFullscreenSupport();
  const isMobileLayout = useMobileLayout();
  useEffect54(() => {
  ...
  return /* @__PURE__ */ jsxs81("div", {
    ...
    children: [
      ...
      isMobileLayout ? null : /* @__PURE__ */ jsxs81(Fragment23, {
        children: [
          /* @__PURE__ */ jsxs81("div", {
            style: sideContainer,
            children: [
              ...
              /* @__PURE__ */ jsx174(TimelineZoomControls, {})
            ]
          }),
          /* @__PURE__ */ jsx174(Flex, {}),
          /* @__PURE__ */ jsx174(SizeSelector, {}),
          isStill || isVideoComposition ? /* @__PURE__ */ jsx174(PlaybackRateSelector, {
            setPlaybackRate,
            playbackRate
          }) : null
        ]
      }),
      isVideoComposition ? /* @__PURE__ */ jsxs81(Fragment23, {
        children: [
          /* @__PURE__ */ jsx174(Spacing, {
            x: 2
          }),
          /* @__PURE__ */ jsx174(PlayPause, {
            bufferStateDelayInMilliseconds,
            loop,
            playbackRate
          }),
          ...
          /* @__PURE__ */ jsx174(LoopToggle, {
            loop,
            setLoop
          }),
          /* @__PURE__ */ jsx174(MuteToggle, {
            muted: mediaMuted,
          ...
          /* @__PURE__ */ jsx174(TimelineInOutPointToggle, {}),
          /* @__PURE__ */ jsx174(Spacing, {
            x: 2
          })
        ]
      }) : null,
      /* @__PURE__ */ jsx174(CheckboardToggle, {}),
      /* @__PURE__ */ jsx174(Spacing, {
        x: 1
      }),
      isFullscreenSupported && /* @__PURE__ */ jsx174(FullScreenToggle, {}),
      /* @__PURE__ */ jsx174(Flex, {}),
      isMobileLayout && /* @__PURE__ */ jsxs81(Fragment23, {
        children: [
          /* @__PURE__ */ jsx174(Flex, {}),
          /* @__PURE__ */ jsx174(SizeSelector, {}),
          isStill || isVideoComposition ? /* @__PURE__ */ jsx174(PlaybackRateSelector, {
      ...
      /* @__PURE__ */ jsxs81("div", {
        ...
        children: [
          /* @__PURE__ */ jsx174(Flex, {}),
          !isMobileLayout && /* @__PURE__ */ jsx174(FpsCounter, {
            playbackSpeed: playbackRate
          }),
          /* @__PURE__ */ jsx174(Spacing, {
            x: 2
          }),
          readOnlyStudio ? null : /* @__PURE__ */ jsx174(RenderButton, {}),
          /* @__PURE__ */ jsx174(Spacing, {
            x: 1.5
          })
        ]
      }),
      /* @__PURE__ */ jsx174(PlaybackKeyboardShortcutsManager, {
        setPlaybackRate
      }),
      /* @__PURE__ */ jsx174(PlaybackRatePersistor, {}),
      /* @__PURE__ */ jsx174("div", {
...
import { useMemo as useMemo93, useRef as useRef29, useState as useState58 } from "react";
...
var SplitterContext = React115.createContext({
  flexValue: 1,
  ref: { current: null },
  setFlexValue: () => {
    return;
...
var SplitterContainer = ({ orientation, children, defaultFlex, maxFlex, minFlex, id }) => {
  ...
  const [flexValue, setFlexValue] = useState58(initialTimelineFlex ?? defaultFlex);
  const ref = useRef29(null);
  const isDragging = useRef29(false);
  const value = useMemo93(() => {
    return {
      flexValue,
      ref,
      setFlexValue,
  ...
  return /* @__PURE__ */ jsx175(SplitterContext.Provider, {
    value,
    children: /* @__PURE__ */ jsx175("div", {
      ref,
...
import { useContext as useContext54, useMemo as useMemo94 } from "react";
import { interpolateColors, random } from "remotion";
import { jsx as jsx176, jsxs as jsxs82, Fragment as Fragment24 } from "react/jsx-runtime";
var SplitterElement = ({ children, type, sticky }) => {
  const context = useContext54(SplitterContext);
  const style9 = useMemo94(() => {
    return {
  ...
  return /* @__PURE__ */ jsxs82(Fragment24, {
    children: [
      /* @__PURE__ */ jsx176("div", {
        style: style9,
        children
...
import { useContext as useContext55, useEffect as useEffect55, useRef as useRef30, useState as useState59 } from "react";
...
var SplitterHandle = ({ allowToCollapse, onCollapse }) => {
  ...
  const [lastPointerUp, setLastPointerUp] = useState59(() => Date.now());
...
// src/components/TopPanel.tsx
import { jsx as jsx178, jsxs as jsxs83 } from "react/jsx-runtime";
var container36 = {
  height: "100%",
  width: "100%",
  display: "flex",
...
var useResponsiveSidebarStatus = () => {
  const { sidebarCollapsedStateLeft } = useContext56(SidebarContext);
  const responsiveLeftStatus = useBreakpoint(1200) ? "collapsed" : "expanded";
  const actualStateLeft = useMemo95(() => {
...
var TopPanel = ({ readOnlyStudio, onMounted, drawRef: drawRef2, bufferStateDelayInMilliseconds }) => {
  const { setSidebarCollapsedState, sidebarCollapsedStateRight } = useContext56(SidebarContext);
  const rulersAreVisible = useIsRulerVisible();
  const actualStateLeft = useResponsiveSidebarStatus();
  const actualStateRight = useMemo95(() => {
  ...
  return /* @__PURE__ */ jsxs83("div", {
    ...
    children: [
      /* @__PURE__ */ jsx178("div", {
        style: row4,
        children: /* @__PURE__ */ jsxs83(SplitterContainer, {
          minFlex: 0.15,
          maxFlex: 0.4,
          defaultFlex: 0.2,
          ...
          orientation: "vertical",
          children: [
            actualStateLeft === "expanded" ? isMobileLayout ? /* @__PURE__ */ jsx178(MobilePanel, {
              onClose: onCollapseLeft,
              children: /* @__PURE__ */ jsx178(ExplorerPanel, {
                readOnlyStudio
              })
            }) : /* @__PURE__ */ jsx178(SplitterElement, {
              sticky: null,
              type: "flexer",
              children: /* @__PURE__ */ jsx178(ExplorerPanel, {
                readOnlyStudio
            ...
            actualStateLeft === "expanded" ? /* @__PURE__ */ jsx178(SplitterHandle, {
                ...
                children: [
                  /* @__PURE__ */ jsx178(SplitterElement, {
                    ...
                    children: /* @__PURE__ */ jsx178("div", {
                      ...
                      children: /* @__PURE__ */ jsx178(CanvasIfSizeIsAvailable, {})
                    })
                  }),
                  actualStateRight === "expanded" ? /* @__PURE__ */ jsx178(SplitterHandle, {
                    allowToCollapse: "right",
                    onCollapse: onCollapseRight
                  }) : null,
                  actualStateRight === "expanded" ? isMobileLayout ? /* @__PURE__ */ jsx178(MobilePanel, {
                    onClose: onCollapseRight,
                    children: /* @__PURE__ */ jsx178(OptionsPanel, {
                      readOnlyStudio
                    })
                  }) : /* @__PURE__ */ jsx178(SplitterElement, {
                    sticky: null,
      ...
      /* @__PURE__ */ jsx178(PreviewToolbar, {
        bufferStateDelayInMilliseconds,
        readOnlyStudio
      }),
      /* @__PURE__ */ jsx178(CurrentCompositionKeybindings, {
        readOnlyStudio
      }),
      /* @__PURE__ */ jsx178(TitleUpdater, {})
    ]
  });
};
...
var SidebarCollapserControls = () => {
  const { setSidebarCollapsedState, sidebarCollapsedStateRight } = useContext57(SidebarContext);
  const keybindings = useKeybinding();
  const leftSidebarStatus = useResponsiveSidebarStatus();
  const leftIcon = useCallback90((color) => {
    return {
      width: "35%",
      height: "100%",
  ...
  const rightIcon = useCallback90((color) => {
    return {
      width: "35%",
      height: "100%",
      right: 0,
  ...
  const toggleLeft = useCallback90(() => {
    setSidebarCollapsedState({
      left: (s) => {
        if (s === "responsive") {
  ...
  const toggleRight = useCallback90(() => {
    setSidebarCollapsedState({
      right: (s) => s === "collapsed" ? "expanded" : "collapsed",
      left: null
    });
  }, [setSidebarCollapsedState]);
  const toggleBoth = useCallback90(() => {
  ...
  const colorStyle = useCallback90((color) => {
    return {
      ...style9,
      color
    };
  }, []);
  const toggleLeftAction = useCallback90((color) => {
    return /* @__PURE__ */ jsx179("div", {
      style: colorStyle(color),
      title: toggleLeftTooltip,
      children: /* @__PURE__ */ jsx179("div", {
        style: leftIcon(color)
      })
    });
  }, [colorStyle, leftIcon, toggleLeftTooltip]);
  const toggleRightAction = useCallback90((color) => {
    return /* @__PURE__ */ jsx179("div", {
      style: colorStyle(color),
...
var UpdateCheck = () => {
  const [info, setInfo] = useState60(null);
  const { setSelectedModal } = useContext58(ModalsContext);
  const { tabIndex } = useZIndex();
  const [knownBugs, setKnownBugs] = useState60(null);
  const hasKnownBugs = useMemo96(() => {
    return knownBugs && knownBugs.length > 0;
  }, [knownBugs]);
  const checkForUpdates = useCallback91(() => {
  ...
  const checkForBugs = useCallback91(() => {
    const controller = new AbortController;
  ...
  const dynButtonStyle = useMemo96(() => {
    return {
      ...buttonStyle4,
  ...
  return /* @__PURE__ */ jsx180("button", {
    tabIndex,
    style: dynButtonStyle,
    onClick: openModal,
    type: "button",
    title: hasKnownBugs ? "Bugfixes available" : "Update available",
    children: hasKnownBugs ? "Bugfixes available" : /* @__PURE__ */ jsx180("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      style: {
        height: 16,
        width: 16
...
var MenuToolbar = ({ readOnlyStudio }) => {
  const [selected, setSelected] = useState61(null);
  const mobileLayout = useMobileLayout();
  const fixedWidthRight = useMemo97(() => {
    return {
  ...
  const fixedWidthLeft = useMemo97(() => {
    return {
  ...
  const itemClicked = useCallback92((itemId) => {
    setSelected(itemId);
  }, [setSelected]);
  const itemHovered = useCallback92((itemId) => {
    if (selected) {
      setSelected(itemId);
    }
  }, [selected, setSelected]);
  const closeMenu = useCallback92(() => {
    setSelected(null);
  }, []);
  const structure = useMenuStructure(closeMenu, readOnlyStudio);
  const menus = useMemo97(() => {
    return structure.map((s) => s.id);
  }, [structure]);
  const onPreviousMenu = useCallback92(() => {
    setSelected((s) => {
      if (s === null) {
        return null;
      }
  ...
  const onNextMenu = useCallback92(() => {
    setSelected((s) => {
      if (s === null) {
        return null;
      }
  ...
  const onItemQuit = useCallback92(() => {
    setSelected(null);
  }, [setSelected]);
  return /* @__PURE__ */ jsxs85(Row, {
    align: "center",
    className: "css-reset",
    style: row5,
    children: [
      /* @__PURE__ */ jsxs85("div", {
        ...
        children: [
          structure.map((s) => {
            return /* @__PURE__ */ jsx181(MenuItem, {
          ...
          readOnlyStudio ? null : /* @__PURE__ */ jsx181(UpdateCheck, {})
        ]
      }),
      /* @__PURE__ */ jsx181("div", {
        style: flex2
      }),
      /* @__PURE__ */ jsx181(MenuBuildIndicator, {}),
      /* @__PURE__ */ jsx181("div", {
        style: flex2
      }),
      /* @__PURE__ */ jsx181("div", {
        style: fixedWidthRight,
        children: /* @__PURE__ */ jsx181(SidebarCollapserControls, {})
      }),
      /* @__PURE__ */ jsx181(Spacing, {
        x: 1
      })
    ]
  });
...
import { useContext as useContext67, useMemo as useMemo109 } from "react";
...
import { jsxs as jsxs86 } from "react/jsx-runtime";
...
import { createRef as createRef10, useContext as useContext59 } from "react";
import { Internals as Internals45 } from "remotion";
import { jsx as jsx182, jsxs as jsxs87, Fragment as Fragment26 } from "react/jsx-runtime";
var areaHighlight = {
  position: "absolute",
...
var TimelineInOutPointer = () => {
  ...
  return /* @__PURE__ */ jsxs87(Fragment26, {
    children: [
      inFrame !== null && /* @__PURE__ */ jsx182("div", {
        ref: inMarkerAreaRef,
        style: {
          ...areaHighlight,
          left: 0,
      ...
      outFrame !== null && /* @__PURE__ */ jsx182("div", {
...
import { createRef as createRef11, useContext as useContext60, useMemo as useMemo98 } from "react";
...
var TimelineInOutPointerHandle = ({
  ...
  const timelineWidth = useContext60(TimelineWidthContext);
  if (timelineWidth === null) {
    return null;
  }
  return /* @__PURE__ */ jsx183(InnerTimelineInOutPointerHandle, {
    atFrame,
    dragging,
    timelineWidth,
    type
...
// src/components/Timeline/TimelineDragHandler.tsx
import { jsx as jsx184, jsxs as jsxs88 } from "react/jsx-runtime";
var inner = {
  overflowY: "auto",
  overflowX: "hidden"
};
...
var TimelineDragHandler = () => {
  ...
  const { canvasContent } = useContext61(Internals46.CompositionManager);
  ...
  return /* @__PURE__ */ jsx184("div", {
    ref: sliderAreaRef,
    style: containerStyle2,
    children: video ? /* @__PURE__ */ jsx184(Inner2, {}) : null
  });
};
var Inner2 = () => {
  ...
  const [inOutDragging, setInOutDragging] = useState62({
    dragging: false
  });
  const timelineWidth = useContext61(TimelineWidthContext);
  const get = useCallback93((frame2) => {
    if (timelineWidth === null) {
  ...
  const { inFrame, outFrame } = useTimelineInOutFramePosition();
  const { setInAndOutFrames } = useTimelineSetInOutFramePosition();
  const [dragging, setDragging] = useState62({
    dragging: false
  });
  const { playing, play, pause, seek } = PlayerInternals16.usePlayer();
  const scroller = useRef31(null);
  const stopInterval = () => {
    if (scroller.current) {
  ...
  const onPointerDown = useCallback93((e) => {
    if (e.button !== 0) {
      return;
    }
    if (!isHighestContext) {
  ...
  const onPointerMoveScrubbing = useCallback93((e) => {
    if (!videoConfig) {
      return;
    }
  ...
  const onPointerMoveInOut = useCallback93((e) => {
    if (!videoConfig) {
      return;
    }
  ...
  const onPointerUpScrubbing = useCallback93((e) => {
    stopInterval();
    if (!videoConfig) {
      return;
    }
  ...
  const onPointerUpInOut = useCallback93((e) => {
    if (!videoConfig) {
      return;
    }
    if (!inOutDragging.dragging) {
  ...
  const outContextMenu = useMemo99(() => {
    return [
      {
        id: "hide-out",
        keyHint: null,
  ...
  return /* @__PURE__ */ jsxs88("div", {
    ...
    children: [
      ...
      inFrame !== null && /* @__PURE__ */ jsx184(ContextMenu, {
        values: inContextMenu,
        children: /* @__PURE__ */ jsx184(TimelineInOutPointerHandle, {
          type: "in",
          atFrame: inFrame,
          dragging: inOutDragging.dragging === "in"
        })
      }),
      outFrame !== null && /* @__PURE__ */ jsx184(ContextMenu, {
...
import { useCallback as useCallback96, useContext as useContext63, useMemo as useMemo101 } from "react";
import { Internals as Internals47 } from "remotion";

// src/components/Timeline/TimelineLayerEye.tsx
import { useCallback as useCallback94 } from "react";
...
var TimelineLayerEye = ({ onInvoked, hidden, type }) => {
  const renderAction = useCallback94((color) => {
    if (hidden) {
      return null;
    }
    if (type === "speaker") {
      return /* @__PURE__ */ jsx185("svg", {
        viewBox: "0 0 10 14",
        fill: "none",
        style: speakerIcon,
        children: /* @__PURE__ */ jsx185("path", {
  ...
  const onPointerEnter = useCallback94(() => {
    if (layerPointedDown) {
      onInvoked(layerPointedDown);
    }
  }, [onInvoked]);
  return /* @__PURE__ */ jsx185("div", {
    style: container39,
    onPointerEnter,
    onPointerDown,
...
var TimelineStack = ({ isCompact, sequence }) => {
  ...
  const [stackHovered, setStackHovered] = useState63(false);
  const [titleHovered, setTitleHovered] = useState63(false);
  const [opening, setOpening] = useState63(false);
  const selectAsset = useSelectAsset();
  const connectionStatus = useContext62(StudioServerConnectionCtx).previewServerState.type;
  const assetPath = useMemo100(() => {
  ...
  const navigateToAsset = useCallback95((asset) => {
    selectAsset(asset);
    pushUrl(`/assets/${asset}`);
  }, [selectAsset]);
  const openEditor = useCallback95(async (location2) => {
  ...
  const onClickTitle = useCallback95(() => {
    if (!titleHoverable) {
      return null;
    }
    if (assetPath) {
  ...
  const onClickStack = useCallback95(() => {
    if (!originalLocation) {
      return;
    }
    if (canOpenInEditor) {
  ...
  const onStackPointerEnter = useCallback95(() => {
    setStackHovered(true);
  }, []);
  const onStackPointerLeave = useCallback95(() => {
    setStackHovered(false);
  }, []);
  const onTitlePointerEnter = useCallback95(() => {
    setTitleHovered(true);
  }, []);
  const onTitlePointerLeave = useCallback95(() => {
    setTitleHovered(false);
  }, []);
  ...
  return /* @__PURE__ */ jsxs89(Fragment27, {
    children: [
      ...
      isCompact || !originalLocation ? null : /* @__PURE__ */ jsx186("div", {
      ...
      opening ? /* @__PURE__ */ jsxs89(Fragment27, {
        children: [
          /* @__PURE__ */ jsx186(Spacing, {
            x: 0.5
          }),
          /* @__PURE__ */ jsx186(Spinner, {
            duration: 0.5,
            size: 12
          })
        ]
...
var TimelineListItem = ({ nestedDepth, sequence, isCompact }) => {
  const { hidden, setHidden } = useContext63(Internals47.SequenceVisibilityToggleContext);
  const padder = useMemo101(() => {
    return {
      width: Number(SPACING * 1.5) * nestedDepth,
      flexShrink: 0
    };
  }, [nestedDepth]);
  const isItemHidden = useMemo101(() => {
    return hidden[sequence.id] ?? false;
  }, [hidden, sequence.id]);
  const onToggleVisibility = useCallback96((type) => {
    setHidden((prev) => {
      return {
        ...prev,
  ...
  return /* @__PURE__ */ jsxs90("div", {
    style: outer2,
    children: [
      /* @__PURE__ */ jsx187(TimelineLayerEye, {
      ...
      sequence.parent && nestedDepth > 0 ? /* @__PURE__ */ jsx187("div", {
        style: space
      }) : null,
      /* @__PURE__ */ jsx187(TimelineStack, {
        sequence,
        isCompact
      })
    ]
...
import { useContext as useContext64, useEffect as useEffect62, useMemo as useMemo102, useRef as useRef33 } from "react";
...
var TimeValue = () => {
  ...
  const onValueChange = useCallback97((val) => {
    seek(val);
  }, [seek]);
  ...
  return /* @__PURE__ */ jsxs91("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx188(Spacing, {
        x: 2
      }),
      /* @__PURE__ */ jsx188(Flex, {}),
      /* @__PURE__ */ jsx188(InputDragger, {
        ref,
        value: frame2,
        onTextChange,
        onValueChange,
...
var TimelineTimePlaceholders = () => {
  return /* @__PURE__ */ jsx189("div", {
    style: timeValue,
    children: /* @__PURE__ */ jsx189(TimeValue, {})
  });
};
...
var TimelineTimeIndicators = () => {
  const sliderTrack = useContext64(TimelineWidthContext);
...
var Inner3 = ({ windowWidth, durationInFrames, fps }) => {
  ...
  return /* @__PURE__ */ jsx189("div", {
    ...
    children: ticks.map((t) => {
      return /* @__PURE__ */ jsx189("div", {
        style: t.style,
        children: t.showTime ? /* @__PURE__ */ jsx189("div", {
          style: tickLabel,
...
var TimelineList = ({ timeline }) => {
  ...
  return /* @__PURE__ */ jsxs92("div", {
    ...
    style: container41,
    children: [
      /* @__PURE__ */ jsx190(TimelineTimePadding, {}),
      timeline.map((track) => {
        return /* @__PURE__ */ jsx190("div", {
          children: /* @__PURE__ */ jsx190(TimelineListItem, {
...
import { useContext as useContext65, useEffect as useEffect63 } from "react";
...
var TimelinePlayCursorSyncer = () => {
  ...
  const timelineContext = useContext65(Internals50.Timeline.TimelineContext);
  const timelinePosition = Internals50.Timeline.useTimelinePosition();
  const { canvasContent } = useContext65(Internals50.CompositionManager);
...
var TimelineScrollable = ({ children }) => {
  const containerStyle2 = useMemo103(() => {
    return {
      width: "100%",
      minHeight: "100%"
    };
...
import { useContext as useContext66, useMemo as useMemo107, useState as useState66 } from "react";
...
import { useEffect as useEffect64, useMemo as useMemo105, useRef as useRef35, useState as useState64 } from "react";
...
// src/components/AudioWaveform.tsx
import { jsx as jsx193, jsxs as jsxs93 } from "react/jsx-runtime";
var container43 = {
  display: "flex",
  flexDirection: "row",
  alignItems: "flex-end",
...
var AudioWaveform = ({
  ...
  const [metadata, setMetadata] = useState64(null);
  const [error, setError] = useState64(null);
  const mountState = useRef35({ isMounted: true });
  const vidConf = Internals51.useUnsafeVideoConfig();
  if (vidConf === null) {
    throw new Error("Expected video config");
  }
  const canvas = useRef35(null);
  useEffect64(() => {
  ...
  return /* @__PURE__ */ jsxs93("div", {
    ...
    children: [
      normalized.map((w) => {
        return /* @__PURE__ */ jsx193(AudioWaveformBar, {
          amplitude: w.amplitude * (typeof volume === "number" ? volume : 1)
        }, w.index);
      }),
      /* @__PURE__ */ jsx193("canvas", {
        ref: canvas,
        style: canvasStyle,
...
import { jsx as jsx194, jsxs as jsxs94 } from "react/jsx-runtime";
var width = {
  width: 30,
  flexDirection: "row",
  display: "flex",
...
var Icon = () => /* @__PURE__ */ jsx194("svg", {
  viewBox: "0 0 512 512",
  style: icon5,
  children: /* @__PURE__ */ jsx194("path", {
    fill: LIGHT_COLOR,
...
// src/components/Timeline/LoopedTimelineIndicators.tsx
import { jsx as jsx195, jsxs as jsxs95 } from "react/jsx-runtime";
var row6 = {
  flexDirection: "row"
};
var LoopedTimelineIndicator = ({ loops }) => {
  return /* @__PURE__ */ jsx195(AbsoluteFill4, {
    style: row6,
    children: new Array(loops).fill(true).map((_l, i) => {
      return /* @__PURE__ */ jsxs95(React134.Fragment, {
        children: [
          /* @__PURE__ */ jsx195(Flex, {}),
          i === loops - 1 ? null : /* @__PURE__ */ jsx195(LoopedIndicator, {})
        ]
      }, i);
    })
  });
...
import { useEffect as useEffect65, useMemo as useMemo106, useRef as useRef36, useState as useState65 } from "react";
import { useVideoConfig as useVideoConfig5 } from "remotion";
import { jsx as jsx197 } from "react/jsx-runtime";
var HEIGHT = TIMELINE_LAYER_HEIGHT - 2;
var containerStyle2 = {
  height: HEIGHT,
  width: "100%",
...
var calculateTimestampSlots = ({
  ...
  const framesFitInWidth = Math.ceil(visualizationWidth / (HEIGHT * aspectRatio));
  const timestampTargets = [];
  for (let i = 0;i < framesFitInWidth; i++) {
    timestampTargets.push(fromSeconds + segmentDuration * WEBCODECS_TIMESCALE / framesFitInWidth * (i + 0.5));
  }
...
var fillWithCachedFrames = ({
  ...
  for (let i = 0;i < filledSlots.size; i++) {
    ...
    for (const key4 of keys) {
      const distance = Math.abs(key4 - timestamp);
    ...
    if (alreadyFilled && Math.abs(alreadyFilled - timestamp) <= Math.abs(frame2.timestamp - timestamp)) {
      continue;
    }
    ctx.drawImage(frame2, i / filledSlots.size * visualizationWidth, 0);
...
var fillFrameWhereItFits = ({
  ...
  for (let i = 0;i < slots.length; i++) {
    ...
    ctx.drawImage(frame2, i / filledSlots.size * visualizationWidth, 0);
    filledSlots.set(slot, frame2.timestamp);
  }
};
var TimelineVideoInfo = ({ src, visualizationWidth, startFrom, durationInFrames }) => {
  ...
  const frameDatabase = useMemo106(() => new Map, []);
  useEffect65(() => {
    if (error) {
      return;
    }
    ...
    extractFrames({
      ...
      timestampsInSeconds: ({ track }) => {
        ...
        const segmentDuration = toSeconds - fromSeconds;
        for (let i = 0;i < framesFitInWidth; i++) {
          timestampTargets.push(fromSeconds + segmentDuration / framesFitInWidth * (i + 0.5));
        }
        return timestampTargets;
      },
      src,
      onFrame: (frame2) => {
        const scale = HEIGHT / frame2.displayHeight;
...
// src/components/Timeline/TimelineSequence.tsx
import { jsx as jsx198, jsxs as jsxs96 } from "react/jsx-runtime";
...
var TimelineSequence = ({ s }) => {
  const windowWidth = useContext66(TimelineWidthContext);
  if (windowWidth === null) {
    return null;
  }
  return /* @__PURE__ */ jsx198(Inner4, {
    windowWidth,
    s
  });
};
var Inner4 = ({ s, windowWidth }) => {
  const [maxMediaDuration, setMaxMediaDuration] = useState66(Infinity);
  ...
  const { marginLeft, width: width2, premountWidth } = useMemo107(() => {
  ...
  return /* @__PURE__ */ jsxs96("div", {
    ...
    title: s.displayName,
    children: [
      premountWidth ? /* @__PURE__ */ jsx198("div", {
        style: {
          width: premountWidth,
          height: "100%",
      ...
      s.type === "video" ? /* @__PURE__ */ jsx198(TimelineVideoInfo, {
        src: s.src,
        visualizationWidth: width2,
        startFrom: s.startMediaFrom,
        durationInFrames: s.duration
...
// src/components/Timeline/TimelineTracks.tsx
import { jsx as jsx199, jsxs as jsxs97 } from "react/jsx-runtime";
var content = {
  ...
  return /* @__PURE__ */ jsxs97("div", {
    ...
    children: [
      /* @__PURE__ */ jsxs97("div", {
        style: content,
        children: [
          /* @__PURE__ */ jsx199(TimelineTimePadding, {}),
          timeline.map((track) => {
            ...
            return /* @__PURE__ */ jsx199("div", {
              style: inner2,
              children: /* @__PURE__ */ jsx199(TimelineSequence, {
                s: track.sequence
              })
            }, track.sequence.id);
          })
      ...
      hasBeenCut ? /* @__PURE__ */ jsx199(MaxTimelineTracksReached, {}) : null
    ]
  });
};

// src/components/Timeline/Timeline.tsx
import { jsx as jsx200, jsxs as jsxs98 } from "react/jsx-runtime";
var container44 = {
  minHeight: "100%",
  flex: 1,
  display: "flex",
...
var Timeline = () => {
  const { sequences } = useContext67(Internals53.SequenceManager);
  ...
  return /* @__PURE__ */ jsx200("div", {
    ...
    children: /* @__PURE__ */ jsx200(TimelineWidthProvider, {
      children: /* @__PURE__ */ jsx200("div", {
        style: inner2,
        children: /* @__PURE__ */ jsxs98(SplitterContainer, {
          orientation: "vertical",
          defaultFlex: 0.2,
          ...
          minFlex: 0.15,
          children: [
            /* @__PURE__ */ jsx200(SplitterElement, {
              type: "flexer",
              sticky: /* @__PURE__ */ jsx200(TimelineTimePlaceholders, {}),
              children: /* @__PURE__ */ jsx200(TimelineList, {
                timeline: shown
              })
            }),
            /* @__PURE__ */ jsx200(SplitterHandle, {
              onCollapse: noop2,
            ...
            /* @__PURE__ */ jsx200(SplitterElement, {
              type: "anti-flexer",
              sticky: null,
              children: /* @__PURE__ */ jsxs98(TimelineScrollable, {
                children: [
                  /* @__PURE__ */ jsx200(TimelineTracks, {
                    timeline: shown,
                    hasBeenCut
                  }),
                  /* @__PURE__ */ jsx200(TimelineInOutPointer, {}),
                  /* @__PURE__ */ jsx200(TimelinePlayCursorSyncer, {}),
                  /* @__PURE__ */ jsx200(TimelineDragHandler, {}),
                  /* @__PURE__ */ jsx200(TimelineTimeIndicators, {}),
                  /* @__PURE__ */ jsx200(TimelineSlider, {})
                ]
              })
            })
          ]
...
// src/components/EditorContent.tsx
import { jsx as jsx201, jsxs as jsxs99, Fragment as Fragment28 } from "react/jsx-runtime";
var noop3 = () => {
  return;
};
var container45 = {
...
var EditorContent = ({ readOnlyStudio, children }) => {
  const isStill = useIsStill();
  const { canvasContent } = useContext68(Internals54.CompositionManager);
  const onlyTopPanel = canvasContent === null || isStill || canvasContent.type !== "composition";
  return /* @__PURE__ */ jsxs99("div", {
    style: container45,
    children: [
      /* @__PURE__ */ jsx201(InitialCompositionLoader, {}),
      /* @__PURE__ */ jsx201(MenuToolbar, {
        readOnlyStudio
      }),
      /* @__PURE__ */ jsxs99(SplitterContainer, {
        orientation: "horizontal",
        id: "top-to-bottom",
        maxFlex: 0.9,
        minFlex: 0.2,
        defaultFlex: 0.75,
        children: [
          /* @__PURE__ */ jsx201(SplitterElement, {
            sticky: null,
            type: "flexer",
            children
          }),
          onlyTopPanel ? null : /* @__PURE__ */ jsxs99(Fragment28, {
            children: [
              /* @__PURE__ */ jsx201(SplitterHandle, {
                allowToCollapse: "none",
                onCollapse: noop3
              }),
              /* @__PURE__ */ jsx201(SplitterElement, {
                sticky: null,
                type: "anti-flexer",
                children: /* @__PURE__ */ jsx201(Timeline, {})
              })
            ]
          })
        ]
...
import { useContext as useContext69, useEffect as useEffect66 } from "react";
...
import React142, { useCallback as useCallback99, useContext as useContext71, useEffect as useEffect67 } from "react";
...
var InstallablePackageComp = ({ isInstalled, pkg, link, description }) => {
  return /* @__PURE__ */ jsxs100("div", {
    ...
    children: [
      ...
      " ",
      isInstalled ? /* @__PURE__ */ jsx202("span", {
...
import { useCallback as useCallback98, useContext as useContext70 } from "react";
...
var DismissableModal = ({ children }) => {
  ...
  const onQuit = useCallback98(() => {
    setSelectedModal(null);
  }, [setSelectedModal]);
  return /* @__PURE__ */ jsx205(ModalContainer, {
    onOutsideClick: onQuit,
    onEscape: onQuit,
    children
  });
...
var InstallPackageModal = ({ packageManager }) => {
  const [state, setState] = React142.useState({ type: "idle" });
  const [map, setMap] = React142.useState({});
  const { previewServerState: ctx } = useContext71(StudioServerConnectionCtx);
  const selectedPackages = Object.keys(map).filter((pkg) => map[pkg]);
  const onClick = useCallback99(async () => {
    if (state.type === "done") {
  ...
  return /* @__PURE__ */ jsxs101(DismissableModal, {
    children: [
      /* @__PURE__ */ jsx206(ModalHeader, {
        title: "Install packages"
      }),
      /* @__PURE__ */ jsx206("div", {
        style: container46,
        className: VERTICAL_SCROLLBAR_CLASSNAME,
        children: state.type === "done" ? /* @__PURE__ */ jsxs101("div", {
          style: text2,
          children: [
            "Installed package",
        ...
        }) : state.type === "restarting" ? /* @__PURE__ */ jsx206("div", {
          style: text2,
          children: "Restarting the Studio server..."
        }) : state.type === "installing" ? /* @__PURE__ */ jsxs101("div", {
          style: text2,
          children: [
            "Installing package",
            selectedPackages.length === 1 ? "" : "s",
          ...
          children: Object.entries(installableMap).filter(([, install]) => install).map(([pkgShort]) => {
            ...
            return /* @__PURE__ */ jsxs101(Row, {
              align: "center",
              children: [
                /* @__PURE__ */ jsx206(Checkbox, {
                  checked: map[pkg],
                  name: pkg,
                  onChange: () => {
                ...
                /* @__PURE__ */ jsx206(Spacing, {
                  x: 1.5
                }),
                /* @__PURE__ */ jsx206(InstallablePackageComp, {
                  description,
                  isInstalled,
                  link,
                  pkg
      ...
      /* @__PURE__ */ jsx206(ModalFooterContainer, {
        children: /* @__PURE__ */ jsxs101(Row, {
          align: "center",
          children: [
            state.type === "idle" ? /* @__PURE__ */ jsxs101("span", {
...
import React143, { useContext as useContext72, useEffect as useEffect68, useMemo as useMemo111 } from "react";
import { Internals as Internals55 } from "remotion";
import { jsx as jsx207, jsxs as jsxs102 } from "react/jsx-runtime";
...
var ResolvedCompositionContext = React143.createContext(null);
var ResolveCompositionBeforeModal = ({ compositionId, children }) => {
  ...
  if (!resolved || resolved.type === "loading") {
    return /* @__PURE__ */ jsx207(RunningCalculateMetadata, {});
  }
  if (resolved.type === "error") {
  ...
  return /* @__PURE__ */ jsx207(ResolvedCompositionContext.Provider, {
    value,
    children
  });
};
...
import { useCallback as useCallback100, useContext as useContext73, useEffect as useEffect69, useState as useState67 } from "react";
...
// src/components/NewComposition/CodemodFooter.tsx
import { jsx as jsx209, jsxs as jsxs104 } from "react/jsx-runtime";
var CodemodFooter = ({
  codemod,
  valid,
  loadingNotification,
  ...
  const [submitting, setSubmitting] = useState67(false);
  const { setSelectedModal } = useContext73(ModalsContext);
  const [codemodStatus, setCanApplyCodemod] = useState67({
    type: "loading"
  });
  const [projectInfo, setProjectInfo] = useState67(null);
  useEffect69(() => {
    const controller = new AbortController;
  ...
  const getCanApplyCodemod = useCallback100(async (signal) => {
  ...
  return /* @__PURE__ */ jsxs104(Row, {
    align: "center",
    children: [
      /* @__PURE__ */ jsx209(CodemodDiffPreview, {
...
// src/components/NewComposition/DeleteComposition.tsx
import { jsx as jsx210, jsxs as jsxs105, Fragment as Fragment29 } from "react/jsx-runtime";
var content3 = {
  padding: 16,
  fontSize: 14,
  flex: 1,
...
var DeleteCompositionLoaded = ({ compositionId }) => {
  const context = useContext74(ResolvedCompositionContext);
  if (!context) {
  ...
  const onSubmit = useCallback101((e) => {
    e.preventDefault();
  }, []);
  return /* @__PURE__ */ jsxs105(Fragment29, {
    children: [
      /* @__PURE__ */ jsx210(ModalHeader, {
        title: "Delete composition"
      }),
      /* @__PURE__ */ jsxs105("form", {
        onSubmit,
        children: [
          ...
          /* @__PURE__ */ jsx210(ModalFooterContainer, {
            children: /* @__PURE__ */ jsx210(CodemodFooter, {
...
var DeleteComposition = ({ compositionId }) => {
  return /* @__PURE__ */ jsx210(DismissableModal, {
    children: /* @__PURE__ */ jsx210(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx210(DeleteCompositionLoaded, {
        compositionId
      })
    })
  });
...
import { useCallback as useCallback103, useContext as useContext75, useMemo as useMemo113, useState as useState68 } from "react";
...
import { jsx as jsx211, jsxs as jsxs106, Fragment as Fragment30 } from "react/jsx-runtime";
var NewCompDuration = ({ durationInFrames, setDurationInFrames }) => {
  const onDurationInFramesChanged = useCallback102((newValue) => {
    setDurationInFrames(Number(newValue));
  }, [setDurationInFrames]);
  const onDurationChangedDirectly = useCallback102((newVal) => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs106("div", {
        ...
        children: [
          ...
          compDurationErrMessage ? /* @__PURE__ */ jsxs106(Fragment30, {
            children: [
              /* @__PURE__ */ jsx211(Spacing, {
                y: 1,
                block: true
              }),
              /* @__PURE__ */ jsx211(ValidationMessage, {
                align: "flex-start",
...
// src/components/NewComposition/DuplicateComposition.tsx
import { jsx as jsx212, jsxs as jsxs107, Fragment as Fragment31 } from "react/jsx-runtime";
var content4 = {
  padding: 12,
  paddingRight: 12,
  flex: 1,
...
var DuplicateCompositionLoaded = ({ initialType }) => {
  ...
  const [initialCompType] = useState68(initialType);
  ...
  const [selectedFrameRate, setFrameRate] = useState68(resolved.result.fps);
  const { compositions } = useContext75(Internals57.CompositionManager);
  const [type, setType] = useState68(initialCompType);
  const [newId, setName] = useState68(() => {
  ...
  const [size4, setSize] = useState68(() => ({
    width: resolved.result.width,
    height: resolved.result.height
  }));
  const [durationInFrames, setDurationInFrames] = useState68(resolved.result.durationInFrames);
  const onTypeChanged = useCallback103((newType) => {
    setType(newType);
  }, []);
  const onWidthChanged = useCallback103((newValue) => {
    setSize((s) => {
      const { height } = s;
  ...
  const onWidthDirectlyChanged = useCallback103((newWidth) => {
    setSize((s) => {
      const { height } = s;
      return {
        height,
  ...
  const onHeightDirectlyChanged = useCallback103((newHeight) => {
    setSize((s) => {
  ...
  const onHeightChanged = useCallback103((newValue) => {
    setSize((s) => {
      const { width: width2 } = s;
  ...
  const onNameChange = useCallback103((e) => {
    setName(e.target.value);
  }, []);
  const onTextFpsChange = useCallback103((newFps) => {
    setFrameRate(Number(newFps));
  }, []);
  const onFpsChange = useCallback103((newFps) => {
    setFrameRate(newFps);
  }, []);
  ...
  const onSubmit = useCallback103((e) => {
    e.preventDefault();
  }, []);
  return /* @__PURE__ */ jsxs107(Fragment31, {
    children: [
      /* @__PURE__ */ jsx212(ModalHeader, {
      ...
      /* @__PURE__ */ jsxs107("form", {
        ...
        children: [
          /* @__PURE__ */ jsxs107("div", {
            style: content4,
            children: [
              initialCompType === "composition" ? /* @__PURE__ */ jsxs107("div", {
                style: optionRow,
                children: [
                  /* @__PURE__ */ jsx212("div", {
                    style: label5,
                  ...
                  /* @__PURE__ */ jsx212("div", {
                    style: rightRow,
                    children: /* @__PURE__ */ jsx212(Combobox, {
                  ...
                  /* @__PURE__ */ jsx212("div", {
                    ...
                    children: /* @__PURE__ */ jsxs107("div", {
                      children: [
                        ...
                        compNameErrMessage ? /* @__PURE__ */ jsxs107(Fragment31, {
                          children: [
                            /* @__PURE__ */ jsx212(Spacing, {
                              y: 1,
                              block: true
                            }),
                            /* @__PURE__ */ jsx212(ValidationMessage, {
                              align: "flex-start",
              ...
              hadDimensionsDefined ? /* @__PURE__ */ jsxs107(Fragment31, {
                children: [
                  /* @__PURE__ */ jsxs107("div", {
                    style: optionRow,
                    children: [
                      ...
                      /* @__PURE__ */ jsxs107("div", {
                        ...
                        children: [
                          ...
                          compWidthErrMessage ? /* @__PURE__ */ jsxs107(Fragment31, {
                            children: [
                              /* @__PURE__ */ jsx212(Spacing, {
                                y: 1,
                                block: true
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxs107("div", {
                        ...
                        children: [
                          ...
                          compHeightErrMessage ? /* @__PURE__ */ jsxs107(Fragment31, {
                            children: [
                              /* @__PURE__ */ jsx212(Spacing, {
                                y: 1,
                                block: true
              ...
              type === "composition" && hadDurationDefined ? /* @__PURE__ */ jsx212(NewCompDuration, {
                durationInFrames,
                setDurationInFrames
              }) : null,
              type === "composition" && hadFpsDefined ? /* @__PURE__ */ jsxs107("div", {
                style: optionRow,
                children: [
                  /* @__PURE__ */ jsx212("div", {
                    style: label5,
                  ...
                  /* @__PURE__ */ jsx212("div", {
                    style: rightRow,
                    children: /* @__PURE__ */ jsx212(InputDragger, {
                      type: "number",
          ...
          /* @__PURE__ */ jsx212(ModalFooterContainer, {
            children: /* @__PURE__ */ jsx212(CodemodFooter, {
...
var DuplicateComposition = ({ compositionId, compositionType }) => {
  return /* @__PURE__ */ jsx212(DismissableModal, {
    children: /* @__PURE__ */ jsx212(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx212(DuplicateCompositionLoaded, {
...
import { useCallback as useCallback104, useContext as useContext76, useMemo as useMemo114, useState as useState69 } from "react";
import { Internals as Internals58 } from "remotion";
import { jsx as jsx213, jsxs as jsxs108, Fragment as Fragment32 } from "react/jsx-runtime";
var content5 = {
  padding: 12,
  paddingRight: 12,
  flex: 1,
...
var RenameCompositionLoaded = () => {
  ...
  const { compositions } = useContext76(Internals58.CompositionManager);
  const [newId, setName] = useState69(() => {
  ...
  return /* @__PURE__ */ jsxs108(Fragment32, {
    children: [
      /* @__PURE__ */ jsx213(ModalHeader, {
        title: `Rename ${resolved.result.id}`
      }),
      /* @__PURE__ */ jsxs108("form", {
        onSubmit,
        children: [
          /* @__PURE__ */ jsx213("div", {
            style: content5,
            children: /* @__PURE__ */ jsxs108("div", {
              style: optionRow,
              children: [
                /* @__PURE__ */ jsx213("div", {
                  style: label5,
                ...
                /* @__PURE__ */ jsx213("div", {
                  ...
                  children: /* @__PURE__ */ jsxs108("div", {
                    children: [
                      ...
                      compNameErrMessage ? /* @__PURE__ */ jsxs108(Fragment32, {
                        children: [
                          /* @__PURE__ */ jsx213(Spacing, {
                            y: 1,
                            block: true
                          }),
                          /* @__PURE__ */ jsx213(ValidationMessage, {
                            align: "flex-start",
                            message: compNameErrMessage,
                            type: "error"
                          })
...
var RenameComposition = ({ compositionId }) => {
  return /* @__PURE__ */ jsx213(DismissableModal, {
    children: /* @__PURE__ */ jsx213(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx213(RenameCompositionLoaded, {})
    })
  });
};
...
var KeyboardShortcutsExplainer = () => {
  return /* @__PURE__ */ jsxs109("div", {
    children: [
      areKeyboardShortcutsDisabled() ? /* @__PURE__ */ jsxs109("div", {
                ...
                children: [
                  /* @__PURE__ */ jsxs109("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx215("kbd", {
                        style: key4,
                        children: /* @__PURE__ */ jsx215(ShiftIcon, {})
                      }),
                      ...
                      /* @__PURE__ */ jsx215("kbd", {
                        style: key4,
                        children: /* @__PURE__ */ jsx215(ArrowLeft, {})
                      })
                    ]
                  }),
                  /* @__PURE__ */ jsx215("div", {
              ...
              /* @__PURE__ */ jsxs109(Row, {
                ...
                children: [
                  /* @__PURE__ */ jsx215("div", {
                    ...
                    children: /* @__PURE__ */ jsx215("kbd", {
                      style: key4,
                      children: /* @__PURE__ */ jsx215(ArrowRight, {})
                    })
                  }),
                  /* @__PURE__ */ jsx215("div", {
                    style: right2,
...
import { useEffect as useEffect70, useMemo as useMemo115, useRef as useRef37, useState as useState70 } from "react";
import { jsx as jsx217, jsxs as jsxs111, Fragment as Fragment33 } from "react/jsx-runtime";
var container49 = {
  paddingLeft: 16,
  paddingRight: 16,
  display: "flex",
...
var QuickSwitcherResult = ({ result, selected }) => {
  const [hovered, setIsHovered] = useState70(false);
  ...
  return /* @__PURE__ */ jsxs111("div", {
    ...
    children: [
      result.type === "composition" ? result.compositionType === "still" ? /* @__PURE__ */ jsx217(StillIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : /* @__PURE__ */ jsx217(FilmIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : null,
      ...
      /* @__PURE__ */ jsx217("div", {
        ...
        children: result.type === "search-result" ? /* @__PURE__ */ jsxs111(Fragment33, {
          children: [
            /* @__PURE__ */ jsx217("div", {
...
// src/components/QuickSwitcher/QuickSwitcherContent.tsx
import { jsx as jsx218, jsxs as jsxs112, Fragment as Fragment34 } from "react/jsx-runtime";
var input2 = {
  width: "100%"
};
var modeSelector = {
...
var QuickSwitcherContent = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  const { compositions } = useContext77(Internals59.CompositionManager);
  const [state, setState] = useState71(() => {
    return {
    ...
    return fuzzySearch(actualQuery, compositions.map((c) => {
      return {
        ...
        onSelected: () => {
          ...
          Internals59.compositionSelectorRef.current?.expandComposition(c.id);
  ...
  const onArrowDown = useCallback105(() => {
    setState((s) => {
      return {
        ...s,
  ...
  const onArrowUp = useCallback105(() => {
    setState((s) => {
      return {
        ...s,
        selectedIndex: s.selectedIndex - 1
  ...
  const onTextChange = useCallback105((e) => {
  ...
  const onActionsSelected = useCallback105(() => {
    setState((s) => ({
  ...
  const onCompositionsSelected = useCallback105(() => {
    setState((s) => ({
      query: stripQuery(s.query),
      selectedIndex: 0
    }));
  ...
  const onDocSearchSelected = useCallback105(() => {
    setState((s) => ({
      query: `? ${stripQuery(s.query)}`,
      selectedIndex: 0
    }));
  ...
  const container50 = useMemo116(() => {
    return {
      width: showKeyboardShortcuts ? 800 : 500
    };
  }, [showKeyboardShortcuts]);
  const results = useMemo116(() => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs112("div", {
        ...
        children: [
          ...
          showKeyboardShortcuts ? /* @__PURE__ */ jsxs112(Fragment34, {
            children: [
              /* @__PURE__ */ jsx218(Spacing, {
                x: 2
              }),
              " ",
              /* @__PURE__ */ jsx218(AlgoliaCredit, {})
            ]
          }) : null
        ]
      }),
      /* @__PURE__ */ jsx218("div", {
        style: results,
        className: VERTICAL_SCROLLBAR_CLASSNAME,
        children: showKeyboardShortcuts ? /* @__PURE__ */ jsx218(KeyboardShortcutsExplainer, {}) : showSearchLoadingState ? null : resultsArray.length === 0 ? /* @__PURE__ */ jsx218(QuickSwitcherNoResults, {
          mode,
          query: actualQuery
        }) : resultsArray.map((result, i) => {
          return /* @__PURE__ */ jsx218(QuickSwitcherResult, {
...
var QuickSwitcher = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  return /* @__PURE__ */ jsx219(DismissableModal, {
    children: /* @__PURE__ */ jsx219(QuickSwitcherContent, {
      readOnlyStudio,
      invocationTimestamp,
      initialMode
    })
...
import { useMemo as useMemo117, useState as useState72 } from "react";
var useRenderModalSections = (renderMode, codec) => {
  const [selectedTab, setTab] = useState72("general");
  const shownTabs = useMemo117(() => {
    if (renderMode === "audio") {
...
var AudioIcon = (props) => /* @__PURE__ */ jsx220("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var DataIcon = (props) => {
  return /* @__PURE__ */ jsx221("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 448 512",
    ...props,
    children: /* @__PURE__ */ jsx221("path", {
      fill: "currentcolor",
...
var PicIcon = (props) => /* @__PURE__ */ jsx222("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var GearIcon = (props) => /* @__PURE__ */ jsx223("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var GifIcon = (props) => /* @__PURE__ */ jsx224("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 576 512",
  ...props,
...
import { useCallback as useCallback106, useMemo as useMemo118, useState as useState73 } from "react";
...
var VerticalTab = ({ children, onClick, style: style11, selected }) => {
  ...
  const { tabIndex } = useZIndex();
  const onPointerEnter = useCallback106(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback106(() => {
    setHovered(false);
  }, []);
  const definiteStyle = useMemo118(() => {
    return {
      ...selectorButton2,
...
import { useCallback as useCallback107, useEffect as useEffect72, useMemo as useMemo119, useState as useState74 } from "react";
...
var CliCopyButton = ({
  ...
  const [copied, setCopied] = useState74(false);
  const [hovered, setHovered] = useState74(false);
  const fillColor = useMemo119(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const clipboardIcon = /* @__PURE__ */ jsx226(ClipboardIcon, {
    color: fillColor,
    style: svgStyle2
  });
  const checkSvg = /* @__PURE__ */ jsx226("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 448 512",
    style: svgStyle2,
    children: /* @__PURE__ */ jsx226("path", {
      fill: fillColor,
      d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"
    })
  });
  const onPointerEnter = useCallback107(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback107(() => {
    setHovered(false);
  }, []);
  useEffect72(() => {
    if (!copied) {
  ...
  return copied ? /* @__PURE__ */ jsx226("span", {
    style: copiedStyle,
    children: checkSvg
        ...
        children: [
          /* @__PURE__ */ jsxs113("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx227("div", {
                style: copyWrapper,
                children: /* @__PURE__ */ jsx227(CliCopyButton, {
                  valueToCopy: option.cliFlag
                })
              })
            ]
          }),
          option.ssrName ? /* @__PURE__ */ jsxs113("div", {
            style: infoRow,
            children: [
              /* @__PURE__ */ jsx227("div", {
                style: infoRowLabel,
...
var OptionExplainerBubble = ({ id }) => {
  ...
  return /* @__PURE__ */ jsx228(InfoBubble, {
    title: "Learn more about this option",
    children: /* @__PURE__ */ jsx228(OptionExplainer, {
      option
    })
  });
};
...
var NumberSetting = ({ name, value, step, hint, onValueChanged, max, min, formatter }) => {
  ...
  const onValueChange = useCallback108((newConcurrency) => {
  ...
  return /* @__PURE__ */ jsxs114("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx229("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsx229(RightAlignInput, {
          children: /* @__PURE__ */ jsx229(InputDragger, {
            value,
...
var useCrfState = (codec) => {
  const [state, setState] = useState75(() => getDefaultCrfState());
  const range2 = BrowserSafeApis2.getValidCrfRanges(codec);
...
var CrfSetting = ({ crf, setCrf, min, max, option }) => {
  return /* @__PURE__ */ jsx230(NumberSetting, {
    min,
    max,
    name: "CRF",
...
import { useCallback as useCallback112, useMemo as useMemo120 } from "react";
...
import React153, { useCallback as useCallback110 } from "react";
...
var InlineEyeButton = ({ onClick, enabled }) => {
  const renderAction = useCallback109((color2) => {
    return enabled ? /* @__PURE__ */ jsx231("svg", {
      style: clearIcon2,
      viewBox: "0 0 640 512",
  ...
  return /* @__PURE__ */ jsx231(InlineAction, {
    renderAction,
    onClick
  });
};
...
var EnvInput = ({
  ...
  const [showInPlainText, setShowInPlainText] = React153.useState(false);
  const [initialWarningKeyMissing, setKeyWarningEligible] = React153.useState(() => {
    return envKey.trim() === "" && envVal.trim() !== "";
  });
  const [initialWarningValMissing, setValueWarningEligible] = React153.useState(() => {
    return envKey.trim() !== "" && envVal.trim() === "";
  });
  ...
  const togglePlainText = useCallback110(() => {
    setShowInPlainText((prev) => !prev);
  }, []);
  const handleKeyChange = useCallback110((e) => {
    onEnvKeyChange(index, e.target.value);
  }, [index, onEnvKeyChange]);
  const handleValueChange = useCallback110((e) => {
    onEnvValChange(index, e.target.value);
  }, [index, onEnvValChange]);
  const makeKeyWarningEligible = useCallback110(() => {
    setKeyWarningEligible(true);
  }, []);
  const makeValueWarningEligible = useCallback110(() => {
    ...
    children: [
      /* @__PURE__ */ jsxs115(Row, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx232(InlineEyeButton, {
            enabled: !showInPlainText,
            onClick: togglePlainText
          }),
          /* @__PURE__ */ jsx232(InlineRemoveButton, {
            onClick: handleDelete
          })
        ]
      }),
      isNodeEnvKey ? /* @__PURE__ */ jsx232("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx232(ValidationMessage, {
          align: "flex-start",
          type: "warning",
          message: "NODE_ENV will be overwritten by Remotion during the render process."
        })
      }) : null,
      isDuplicate ? /* @__PURE__ */ jsx232("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx232(ValidationMessage, {
          align: "flex-start",
          type: "warning",
      ...
      isKeyMissing ? /* @__PURE__ */ jsx232("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx232(ValidationMessage, {
          align: "flex-start",
          type: "warning",
      ...
      isValMissing ? /* @__PURE__ */ jsx232("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx232(ValidationMessage, {
          align: "flex-start",
          type: "warning",
...
// src/components/RenderModal/RenderModalEnvironmentVariables.tsx
import { jsx as jsx233, jsxs as jsxs116 } from "react/jsx-runtime";
var title6 = {
  fontSize: 14,
  fontWeight: "bold",
  color: LIGHT_TEXT,
...
var RenderModalEnvironmentVariables = ({ envVariables, setEnvVariables }) => {
  const onEnvValChange = useCallback111((index, value) => {
  ...
  const onEnvKeyChange = useCallback111((index, value) => {
    setEnvVariables((oldEnv) => {
      const newEnv = [...oldEnv];
  ...
  const onDelete = useCallback111((index) => {
    setEnvVariables((oldEnv) => oldEnv.filter((_, idx) => idx !== index));
  }, [setEnvVariables]);
  const addField = useCallback111(() => {
  ...
  return /* @__PURE__ */ jsxs116("div", {
    ...
    children: [
      ...
      envVariables.map((env, i) => {
        ...
        return /* @__PURE__ */ jsx233(EnvInput, {
          onEnvKeyChange,
          onEnvValChange,
          envKey: env[0],
          envVal: env[1],
      ...
      /* @__PURE__ */ jsx233(Spacing, {
        y: 1,
        block: true
      }),
      /* @__PURE__ */ jsx233(Button, {
        style: button4,
        onClick: addField,
...
var RenderModalHr = () => {
  return /* @__PURE__ */ jsx234("div", {
    style: hrStyle
  });
};

// src/components/RenderModal/RenderModalAdvanced.tsx
import { jsx as jsx235, jsxs as jsxs117 } from "react/jsx-runtime";
var container52 = {
  flex: 1,
  overflowY: "auto"
};
var RenderModalAdvanced = ({
  ...
  const extendedOpenGlOptions = useMemo120(() => {
    return [
      "angle",
      "egl",
      "swangle",
  ...
  const toggleCustomOffthreadVideoCacheSizeInBytes = useCallback112(() => {
  ...
  const toggleCustomOffthreadVideoThreads = useCallback112(() => {
  ...
  const toggleCustomUserAgent = useCallback112(() => {
  ...
  const onDisallowParallelEncodingChanged = useCallback112((e) => {
    setDisallowParallelEncoding(e.target.checked);
  }, [setDisallowParallelEncoding]);
  const onDisableWebSecurityChanged = useCallback112((e) => {
    setDisableWebSecurity(e.target.checked);
  }, [setDisableWebSecurity]);
  const onEnableMultiProcessOnLinux = useCallback112((e) => {
    setChromiumMultiProcessOnLinux(e.target.checked);
  }, [setChromiumMultiProcessOnLinux]);
  const onIgnoreCertificatErrors = useCallback112((e) => {
    setIgnoreCertificateErrors(e.target.checked);
  }, [setIgnoreCertificateErrors]);
  const onHeadless = useCallback112((e) => {
    setHeadless(e.target.checked);
  }, [setHeadless]);
  const onUserAgentChanged = useCallback112((e) => {
    setUserAgent(e.target.value);
  }, [setUserAgent]);
  const onPlayBeepSound = useCallback112((e) => {
    setBeep(e.target.checked);
  }, [setBeep]);
  const onReproToggle = useCallback112((e) => {
    setRepro(e.target.checked);
  }, [setRepro]);
  const openGlOptions = useMemo120(() => {
    return extendedOpenGlOptions.map((option) => {
      return {
        label: option === "default" ? "Default" : option,
        onClick: () => setOpenGlOption(option),
        key: option,
        leftItem: openGlOption === option ? /* @__PURE__ */ jsx235(Checkmark, {}) : null,
        id: option,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const chromeModeOptions = useMemo120(() => {
    return BrowserSafeApis3.validChromeModeOptions.map((option) => {
      return {
        label: option,
        onClick: () => setChromeModeOption(option),
        key: option,
        leftItem: chromeModeOption === option ? /* @__PURE__ */ jsx235(Checkmark, {}) : null,
        id: option,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const x264PresetOptions = useMemo120(() => {
    return BrowserSafeApis3.x264PresetOptions.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: x264Preset === option ? /* @__PURE__ */ jsx235(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        value: option
      };
  ...
  const hardwareAccelerationValues = useMemo120(() => {
    return BrowserSafeApis3.hardwareAccelerationOptions.map((option) => {
      return {
        label: option,
        onClick: () => setHardwareAcceleration(option),
        leftItem: hardwareAcceleration === option ? /* @__PURE__ */ jsx235(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null,
        type: "item",
        id: option,
  ...
  const changeOffthreadVideoCacheSizeInBytes = useCallback112((cb) => {
  ...
  const changeOffthreadVideoThreads = useCallback112((cb) => {
  ...
  return /* @__PURE__ */ jsxs117("div", {
    ...
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: [
      renderMode === "still" ? null : /* @__PURE__ */ jsx235(NumberSetting, {
        min: minConcurrency,
        max: maxConcurrency,
        step: 1,
        name: "Concurrency",
      ...
      renderMode === "video" && codec === "h264" ? /* @__PURE__ */ jsxs117("div", {
        style: optionRow,
        children: [
      ...
      renderMode === "video" ? /* @__PURE__ */ jsxs117("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsxs117("div", {
            style: label5,
      ...
      renderMode === "audio" || offthreadVideoCacheSizeInBytes === null ? null : /* @__PURE__ */ jsx235(NumberSetting, {
        min: 0,
        max: 2000 * 1024 * 1024,
        step: 1024,
      ...
      renderMode === "audio" ? null : /* @__PURE__ */ jsxs117("div", {
        ...
        children: [
          /* @__PURE__ */ jsx235("div", {
            style: label5,
            children: "OffthreadVideo threads"
          }),
          /* @__PURE__ */ jsx235(Spacing, {
            x: 0.5
          }),
      ...
      renderMode === "audio" || offthreadVideoThreads === null ? null : /* @__PURE__ */ jsx235(NumberSetting, {
        min: 0,
        max: 16,
        step: 1,
      ...
      userAgent === null ? null : /* @__PURE__ */ jsxs117("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx235("div", {
            style: label5,
          ...
          /* @__PURE__ */ jsx235("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx235("div", {
              children: /* @__PURE__ */ jsx235(RemotionInput, {
                style: input,
                value: userAgent,
      ...
      /* @__PURE__ */ jsx235(RenderModalHr, {}),
      /* @__PURE__ */ jsx235(RenderModalEnvironmentVariables, {
        envVariables,
        setEnvVariables
      })
    ]
...
import { jsx as jsx236, jsxs as jsxs118 } from "react/jsx-runtime";
var EnforceAudioTrackSetting = ({ enforceAudioTrack, muted, setEnforceAudioTrack }) => {
  const onEnforceAudioTrackChanged = useCallback113((e) => {
  ...
  return /* @__PURE__ */ jsxs118("div", {
    ...
    children: [
      /* @__PURE__ */ jsxs118("div", {
        ...
        children: [
          "Enforce Audio Track",
          /* @__PURE__ */ jsx236(Spacing, {
            x: 0.5
          }),
          /* @__PURE__ */ jsx236(OptionExplainerBubble, {
      ...
      /* @__PURE__ */ jsx236("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsx236(Checkbox, {
...
import { useCallback as useCallback114 } from "react";
import { jsx as jsx237, jsxs as jsxs119 } from "react/jsx-runtime";
var MutedSetting = ({ muted, setMuted, enforceAudioTrack }) => {
  const onMutedChanged = useCallback114((e) => {
...
import { useCallback as useCallback115, useMemo as useMemo121 } from "react";

// src/helpers/use-file-existence.ts
import { useContext as useContext78, useEffect as useEffect73, useRef as useRef39, useState as useState76 } from "react";
var useFileExistence = (outName) => {
  const [exists, setExists] = useState76(false);
  const { previewServerState: state, subscribeToEvent } = useContext78(StudioServerConnectionCtx);
  const clientId = state.type === "connected" ? state.clientId : undefined;
  const currentOutName = useRef39("");
...
var RenderModalOutputName = ({
  ...
  return /* @__PURE__ */ jsxs120("div", {
    style: optionRow,
    children: [
      /* @__PURE__ */ jsx238(Column, {
        children: /* @__PURE__ */ jsx238("div", {
          style: label5,
          children: labelText
        })
      }),
      /* @__PURE__ */ jsx238("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsxs120("div", {
          children: [
            /* @__PURE__ */ jsx238(RemotionInput, {
            ...
            validationMessage ? /* @__PURE__ */ jsxs120(Fragment38, {
              children: [
                ...
                /* @__PURE__ */ jsx238(ValidationMessage, {
                  align: "flex-end",
...
var SeparateAudioOptionInput = ({ separateAudioTo, setSeparateAudioTo, audioCodec }) => {
  ...
  const validationMessage = useMemo121(() => {
  ...
  return /* @__PURE__ */ jsx239(RenderModalOutputName, {
    existence,
    inputStyle: input,
    onValueChange,
...
var SeparateAudioOption = ({ separateAudioTo, setSeparateAudioTo, audioCodec, outName }) => {
  const onSeparateAudioChange = useCallback115((e) => {
    if (e.target.checked) {
  ...
  return /* @__PURE__ */ jsxs121(Fragment39, {
    children: [
        ...
        children: [
          /* @__PURE__ */ jsxs121("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx239(OptionExplainerBubble, {
          ...
          /* @__PURE__ */ jsx239("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx239(Checkbox, {
              disabled: false,
      ...
      separateAudioTo === null ? null : /* @__PURE__ */ jsx239(SeparateAudioOptionInput, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec
      })
...
var RenderModalAudio = ({
  ...
  const onShouldHaveTargetAudioBitrateChanged = useCallback116((e) => {
    setShouldHaveCustomTargetAudioBitrate(e.target.checked);
  }, [setShouldHaveCustomTargetAudioBitrate]);
  const onTargetAudioBitrateChanged = useCallback116((e) => {
    setCustomTargetAudioBitrateValue(e.target.value);
  }, [setCustomTargetAudioBitrateValue]);
  const onSeamlessAacConcatenationChanges = useCallback116((e) => {
    setForSeamlessAacConcatenation(e.target.checked);
  }, [setForSeamlessAacConcatenation]);
  const audioCodecOptions = useCallback116((currentCodec) => {
    return BrowserSafeApis5.supportedAudioCodecs[currentCodec].map((audioCodecOption) => {
      return {
        ...
        leftItem: codec === audioCodecOption ? /* @__PURE__ */ jsx240(Checkmark, {}) : null,
        id: audioCodecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
    ...
    children: [
      renderMode === "video" ? /* @__PURE__ */ jsxs122(Fragment40, {
        children: [
          ...
          /* @__PURE__ */ jsx240(RenderModalHr, {})
        ]
      }) : null,
      renderMode === "video" && audioCodecOptions(codec).length >= 2 && !muted ? /* @__PURE__ */ jsxs122("div", {
        style: optionRow,
        children: [
      ...
      renderMode === "video" && !muted ? /* @__PURE__ */ jsx240(SeparateAudioOption, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec,
        outName
      }) : null,
      audioCodec === "aac" && !muted ? /* @__PURE__ */ jsxs122("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsxs122("div", {
            style: label5,
      ...
      renderMode === "still" || muted ? null : /* @__PURE__ */ jsxs122("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsxs122("div", {
            style: label5,
      ...
      shouldHaveCustomTargetAudioBitrate && renderMode !== "still" && !muted ? /* @__PURE__ */ jsxs122("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx240("div", {
            style: label5,
...
import { useCallback as useCallback117, useMemo as useMemo122 } from "react";
import { jsx as jsx241, jsxs as jsxs123 } from "react/jsx-runtime";
var container54 = {
  borderColor: "black",
  borderStyle: "solid",
  borderWidth: "2px",
...
var MultiRangeSlider = ({
  ...
  const getPercent = useCallback117((value) => Math.round((value - min) / (max - min) * 100), [min, max]);
  const rangeStyle = useMemo122(() => {
  ...
  const onChangeLeft = useCallback117((event) => {
    const value = Math.min(Number(event.target.value), end - 1);
    onLeftThumbDrag(value);
  }, [end, onLeftThumbDrag]);
  const onChangeRight = useCallback117((event) => {
...
// src/components/RenderModal/FrameRangeSetting.tsx
import { jsx as jsx242, jsxs as jsxs124 } from "react/jsx-runtime";
var INPUT_WIDTH = 40;
var FrameRangeSetting = ({ startFrame, endFrame, setEndFrame, durationInFrames, setStartFrame }) => {
  ...
  const onStartFrameChangedDirectly = useCallback118((newStartFrame) => {
    setStartFrame(newStartFrame);
  }, [setStartFrame]);
  const onEndFrameChangedDirectly = useCallback118((newEndFrame) => {
    setEndFrame(newEndFrame);
  }, [setEndFrame]);
  const onStartFrameChanged = useCallback118((newVal) => {
    onStartFrameChangedDirectly(parseInt(newVal, 10));
  }, [onStartFrameChangedDirectly]);
  const onEndFrameChanged = useCallback118((newVal) => {
      ...
      /* @__PURE__ */ jsxs124("div", {
        ...
        children: [
          /* @__PURE__ */ jsx242("div", {
            ...
            children: /* @__PURE__ */ jsx242(InputDragger, {
              min: minStartFrame,
              max: endFrame - 1,
              name: "Start frame",
              value: startFrame,
          ...
          /* @__PURE__ */ jsx242(MultiRangeSlider, {
            min: minStartFrame,
            max: maxEndFrame,
            start: startFrame,
            end: endFrame,
...
// src/components/RenderModal/RenderModalBasic.tsx
import { jsx as jsx243, jsxs as jsxs125 } from "react/jsx-runtime";
var container55 = {
  flex: 1
};
var RenderModalBasic = ({
  ...
  const videoCodecOptions = useMemo123(() => {
    return BrowserSafeApis6.validCodecs.filter((c) => {
      ...
      return {
        ...
        key: codecOption,
        leftItem: codec === codecOption ? /* @__PURE__ */ jsx243(Checkmark, {}) : null,
        id: codecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const proResProfileOptions = useMemo123(() => {
  ...
  const onFrameSetDirectly = useCallback119((newFrame) => {
    setFrame(newFrame);
  }, [setFrame]);
  const onFrameChanged = useCallback119((e) => {
    setFrame((q) => {
  ...
  const onVerboseLoggingChanged = useCallback119((e) => {
    setVerboseLogging(e.target.checked ? "verbose" : "info");
  }, [setVerboseLogging]);
  return /* @__PURE__ */ jsxs125("div", {
    style: container55,
    children: [
      renderMode === "still" || renderMode === "sequence" ? /* @__PURE__ */ jsxs125("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx243("div", {
            style: label5,
          ...
          /* @__PURE__ */ jsx243("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx243(SegmentedControl, {
      ...
      renderMode === "still" && resolvedComposition.durationInFrames > 1 ? /* @__PURE__ */ jsxs125("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx243("div", {
            style: label5,
          ...
          /* @__PURE__ */ jsx243("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx243(RightAlignInput, {
              children: /* @__PURE__ */ jsx243(InputDragger, {
                value: frame2,
      ...
      renderMode === "video" && codec === "prores" ? /* @__PURE__ */ jsxs125("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx243("div", {
            style: label5,
      ...
      renderMode === "still" ? null : /* @__PURE__ */ jsx243(FrameRangeSetting, {
      ...
      /* @__PURE__ */ jsx243(RenderModalOutputName, {
        existence,
        inputStyle: input,
        outName,
        onValueChange,
...
import { jsx as jsx244, jsxs as jsxs126 } from "react/jsx-runtime";
var min = 0;
var NumberOfLoopsSetting = ({ numberOfGifLoops, setNumberOfGifLoops }) => {
  const onNumberOfGifLoopsChangedDirectly = useCallback120((newConcurrency) => {
    setNumberOfGifLoops(newConcurrency);
  }, [setNumberOfGifLoops]);
  const onNumberOfGifLoopsChanged = useCallback120((e) => {
  ...
  return /* @__PURE__ */ jsxs126("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx244("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsx244(RightAlignInput, {
          children: /* @__PURE__ */ jsx244(InputDragger, {
...
// src/components/RenderModal/RenderModalGif.tsx
import { jsx as jsx245, jsxs as jsxs127 } from "react/jsx-runtime";
var container56 = {
  flex: 1
};
var RenderModalGif = ({
  ...
  const onShouldLimitNumberOfGifLoops = useCallback121((e) => {
    setLimitNumberOfGifLoops(e.target.checked);
  }, [setLimitNumberOfGifLoops]);
  return /* @__PURE__ */ jsxs127("div", {
    style: container56,
    children: [
      /* @__PURE__ */ jsx245(NumberSetting, {
      ...
      limitNumberOfGifLoops ? /* @__PURE__ */ jsx245(NumberOfLoopsSetting, {
...
import { useCallback as useCallback122, useMemo as useMemo124 } from "react";
...
var JpegQualitySetting = ({ jpegQuality, setJpegQuality }) => {
  return /* @__PURE__ */ jsx246(NumberSetting, {
...
var ScaleSetting = ({ scale, setScale }) => {
  return /* @__PURE__ */ jsx247(NumberSetting, {
    min: MIN_SCALE,
    max: MAX_SCALE,
    step: 0.1,
    name: "Scale",
...
var RenderModalPicture = ({
  ...
  const colorSpaceOptions = useMemo124(() => {
    return BrowserSafeApis7.validColorSpaces.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: colorSpace === option ? /* @__PURE__ */ jsx248(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  const qualityControlOptions = useMemo124(() => {
  ...
  const onTargetVideoBitrateChanged = useCallback122((e) => {
    setCustomTargetVideoBitrateValue(e.target.value);
  }, [setCustomTargetVideoBitrateValue]);
  const onEncodingBufferSizeToggled = useCallback122((e) => {
    setEncodingBufferSize(e.target.checked ? "10000k" : null);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateToggled = useCallback122((e) => {
    setEncodingMaxRate(e.target.checked ? "5000k" : null);
  }, [setEncodingMaxRate]);
  const onEncodingBufferSizeChanged = useCallback122((e) => {
    setEncodingBufferSize(e.target.value);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateChanged = useCallback122((e) => {
  ...
  return /* @__PURE__ */ jsxs128("div", {
    ...
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: [
      renderMode === "video" ? /* @__PURE__ */ jsxs128("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx248("div", {
            style: label5,
          ...
          /* @__PURE__ */ jsx248("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx248(SegmentedControl, {
              items: imageFormatOptions,
              needsWrapping: false
            })
          })
      ...
      renderMode === "video" && videoImageFormat === "jpeg" && /* @__PURE__ */ jsx248(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "still" && stillImageFormat === "jpeg" && /* @__PURE__ */ jsx248(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "video" && qualityControlType !== null ? /* @__PURE__ */ jsx248(RenderModalHr, {}) : null,
      shouldDisplayQualityControlPicker && renderMode === "video" ? /* @__PURE__ */ jsxs128("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx248("div", {
            style: label5,
      ...
      qualityControlType === "crf" && renderMode !== "still" && renderMode !== "sequence" && crf !== null ? /* @__PURE__ */ jsx248(CrfSetting, {
        crf,
        min: minCrf,
        max: maxCrf,
        setCrf,
      ...
      qualityControlType === "bitrate" && renderMode === "video" ? /* @__PURE__ */ jsxs128("div", {
        style: optionRow,
        children: [
      ...
      renderMode === "video" ? /* @__PURE__ */ jsxs128(Fragment41, {
        children: [
          ...
          encodingBufferSize === null ? null : /* @__PURE__ */ jsxs128("div", {
            style: optionRow,
            children: [
              /* @__PURE__ */ jsx248("div", {
                style: label5,
          ...
          encodingMaxRate === null ? null : /* @__PURE__ */ jsxs128("div", {
            style: optionRow,
            children: [
              /* @__PURE__ */ jsx248("div", {
                style: label5,
      ...
      renderMode === "video" ? /* @__PURE__ */ jsx248(RenderModalHr, {}) : null,
      /* @__PURE__ */ jsx248(ScaleSetting, {
        scale,
        setScale
      }),
      renderMode === "video" ? /* @__PURE__ */ jsx248(RenderModalHr, {}) : null,
...
var RenderModal = ({
  ...
  const context = useContext79(ResolvedCompositionContext);
  if (!context) {
  ...
  const isMounted = useRef40(true);
  const [isVideo] = useState77(() => {
  ...
  const [unclampedFrame, setFrame] = useState77(() => initialFrame);
  const [saving, setSaving] = useState77(false);
  const [stillImageFormat, setStillImageFormat] = useState77(() => initialStillImageFormat);
  const [videoImageFormat, setVideoImageFormat] = useState77(() => initialVideoImageFormat);
  const [sequenceImageFormat, setSequenceImageFormat] = useState77(() => initialStillImageFormat === "jpeg" ? "jpeg" : "png");
  const [concurrency, setConcurrency] = useState77(() => initialConcurrency);
  const [videoCodecForVideoTab, setVideoCodecForVideoTab] = useState77(() => initialVideoCodecForVideoTab);
  const [userSelectedAudioCodec, setUserSelectedAudioCodec] = useState77(() => initialAudioCodec);
  const [separateAudioTo, setSeparateAudioTo] = useState77(null);
  const [envVariables, setEnvVariables] = useState77(() => envVariablesObjectToArray(initialEnvVariables).filter(([key5]) => key5 !== "NODE_ENV"));
  const [initialOutName] = useState77(() => {
  ...
  const [videoCodecForAudioTab, setVideoCodecForAudioTab] = useState77(() => initialVideoCodecForAudioTab);
  const [mutedState, setMuted] = useState77(() => initialMuted);
  const [repro, setRepro] = useState77(() => initialRepro);
  const [enforceAudioTrackState, setEnforceAudioTrackState] = useState77(() => initialEnforceAudioTrack);
  const [forSeamlessAacConcatenation, setForSeamlessAacConcatenation] = useState77(() => initialForSeamlessAacConcatenation);
  const [renderMode, setRenderModeState] = useState77(initialRenderType);
  const [jpegQuality, setJpegQuality] = useState77(() => initialJpegQuality);
  const [scale, setScale] = useState77(() => initialScale);
  const [logLevel, setLogLevel] = useState77(() => initialLogLevel);
  const [disallowParallelEncoding, setDisallowParallelEncoding] = useState77(false);
  const [disableWebSecurity, setDisableWebSecurity] = useState77(() => initialDisableWebSecurity);
  const [headless, setHeadless] = useState77(() => initialHeadless);
  const [beepOnFinish, setBeepOnFinish] = useState77(() => initialBeep);
  const [ignoreCertificateErrors, setIgnoreCertificateErrors] = useState77(() => initialIgnoreCertificateErrors);
  const [multiProcessOnLinux, setChromiumMultiProcessOnLinux] = useState77(() => initialMultiProcessOnLinux);
  const [openGlOption, setOpenGlOption] = useState77(() => initialGl ?? "default");
  const [colorSpace, setColorSpace] = useState77(() => initialColorSpace);
  const [userAgent, setUserAgent] = useState77(() => initialUserAgent === null ? null : initialUserAgent.trim() === "" ? null : initialUserAgent);
  const chromiumOptions = useMemo125(() => {
    return {
      headless,
      disableWebSecurity,
      ignoreCertificateErrors,
  ...
  const [outName, setOutName] = useState77(() => initialOutName);
  const [endFrameOrNull, setEndFrame] = useState77(() => outFrameMark ?? null);
  const [startFrameOrNull, setStartFrame] = useState77(() => inFrameMark ?? null);
  const [proResProfileSetting, setProResProfile] = useState77(() => initialProResProfile);
  const [x264PresetSetting, setx264Preset] = useState77(() => initialx264Preset);
  const [hardwareAcceleration, setHardwareAcceleration] = useState77(() => initialHardwareAcceleration);
  const [userPreferredPixelFormat, setPixelFormat] = useState77(() => initialPixelFormat);
  const [preferredQualityControlType, setQualityControl] = useState77(() => initialVideoBitrate === null ? "crf" : "bitrate");
  const [
    shouldHaveCustomTargetAudioBitrate,
    setShouldHaveCustomTargetAudioBitrate
  ] = useState77(() => initialAudioBitrate !== null);
  const [customTargetAudioBitrate, setCustomTargetAudioBitrateValue] = useState77(() => initialAudioBitrate ?? "320K");
  const [customTargetVideoBitrate, setCustomTargetVideoBitrateValue] = useState77(() => initialVideoBitrate ?? "1M");
  const [encodingMaxRate, setEncodingMaxRate] = useState77(() => initialEncodingMaxRate ?? null);
  const [encodingBufferSize, setEncodingBufferSize] = useState77(() => initialEncodingBufferSize ?? null);
  const [limitNumberOfGifLoops, setLimitNumberOfGifLoops] = useState77(() => initialNumberOfGifLoops !== null);
  const [numberOfGifLoopsSetting, setNumberOfGifLoopsSetting] = useState77(() => initialNumberOfGifLoops ?? 0);
  ...
  const supportsBothQualityControls = useMemo125(() => {
    return supportsCrf && supportsVideoBitrate;
  }, [supportsCrf, supportsVideoBitrate]);
  const qualityControlType = useMemo125(() => {
  ...
  const dispatchIfMounted = useCallback123((payload) => {
    if (isMounted.current === false)
      return;
    dispatch(payload);
  }, []);
  const muted = useMemo125(() => {
    if (renderMode === "video") {
      return mutedState;
    }
    return false;
  }, [mutedState, renderMode]);
  const enforceAudioTrack = useMemo125(() => {
    if (renderMode === "video") {
  ...
  const deriveFinalAudioCodec = useCallback123((passedVideoCodec, passedAudioCodec) => {
  ...
  const setDefaultOutName = useCallback123((options) => {
  ...
  const setAudioCodec = useCallback123((newAudioCodec) => {
  ...
  const setCodec = useCallback123((newCodec) => {
    if (renderMode === "audio") {
  ...
  const setStillFormat = useCallback123((format) => {
    setStillImageFormat(format);
    setDefaultOutName({ type: "still", imageFormat: format });
  }, [setDefaultOutName]);
  const { setSidebarCollapsedState } = useContext79(SidebarContext);
  const onClickStill = useCallback123(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
  ...
  const availablePixelFormats = useMemo125(() => {
    return BrowserSafeApis10.validPixelFormatsForCodec(codec);
  }, [codec]);
  const pixelFormat = useMemo125(() => {
  ...
  const onClickVideo = useCallback123(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const onClickSequence = useCallback123(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const imageFormatOptions = useMemo125(() => {
    if (renderMode === "still") {
      return [
        {
          label: "PNG",
  ...
  const setRenderMode = useCallback123((newRenderMode) => {
  ...
  const renderTabOptions = useMemo125(() => {
  ...
  const pixelFormatOptions = useMemo125(() => {
    return availablePixelFormats.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: pixelFormat === option ? /* @__PURE__ */ jsx249(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  return /* @__PURE__ */ jsxs129("div", {
    style: outer4,
    children: [
      /* @__PURE__ */ jsx249(ModalHeader, {
        title: `Render ${resolvedComposition.id}`
      }),
      /* @__PURE__ */ jsxs129("div", {
        style: container58,
        children: [
          /* @__PURE__ */ jsx249(SegmentedControl, {
      ...
      /* @__PURE__ */ jsxs129("div", {
        ...
        children: [
          /* @__PURE__ */ jsxs129("div", {
            style: leftSidebar,
            children: [
              shownTabs.includes("general") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                style: horizontalTab,
                ...
                children: [
                  /* @__PURE__ */ jsx249("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx249(FileIcon, {
                      style: icon6
                    })
                  }),
                  "General"
              ...
              shownTabs.includes("data") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                style: horizontalTab,
                selected: tab === "data",
                onClick: () => setTab("data"),
                children: [
                  /* @__PURE__ */ jsx249("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx249(DataIcon, {
                      style: icon6
                    })
                  }),
                  "Input Props"
              ...
              shownTabs.includes("picture") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                style: horizontalTab,
                ...
                children: [
                  /* @__PURE__ */ jsx249("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx249(PicIcon, {
                      style: icon6
                    })
                  }),
                  "Picture"
              ...
              shownTabs.includes("audio") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                style: horizontalTab,
                selected: tab === "audio",
                ...
                children: [
                  /* @__PURE__ */ jsx249("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx249(AudioIcon, {
                      style: icon6
                    })
                  }),
                  "Audio"
              ...
              shownTabs.includes("gif") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                style: horizontalTab,
                selected: tab === "gif",
                onClick: () => setTab("gif"),
                children: [
                  /* @__PURE__ */ jsx249("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx249(GifIcon, {
                      style: icon6
                    })
                  }),
                  "GIF"
              ...
              shownTabs.includes("advanced") ? /* @__PURE__ */ jsxs129(VerticalTab, {
                style: horizontalTab,
                ...
                children: [
                  /* @__PURE__ */ jsx249("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx249(GearIcon, {
                      style: icon6
                    })
                  }),
                  "Other"
          ...
          /* @__PURE__ */ jsx249("div", {
            style: optionsPanel,
            className: VERTICAL_SCROLLBAR_CLASSNAME,
            children: tab === "general" ? /* @__PURE__ */ jsx249(RenderModalBasic, {
              codec,
              resolvedComposition,
              frame: frame2,
              imageFormatOptions,
            ...
            }) : tab === "picture" ? /* @__PURE__ */ jsx249(RenderModalPicture, {
              renderMode,
              scale,
              setScale,
              pixelFormat,
              ...
              encodingMaxRate,
              setEncodingMaxRate
            }) : tab === "audio" ? /* @__PURE__ */ jsx249(RenderModalAudio, {
              muted,
              renderMode,
              setMuted,
              codec,
              ...
              setSeparateAudioTo,
              outName
            }) : tab === "gif" ? /* @__PURE__ */ jsx249(RenderModalGif, {
              everyNthFrame,
              limitNumberOfGifLoops,
              numberOfGifLoopsSetting,
              setEveryNthFrameSetting,
              setLimitNumberOfGifLoops,
              setNumberOfGifLoopsSetting
            }) : tab === "data" ? /* @__PURE__ */ jsx249(DataEditor, {
            ...
            }) : /* @__PURE__ */ jsx249(RenderModalAdvanced, {
              x264Preset,
              setx264Preset,
              concurrency,
              maxConcurrency,
...
var RenderModalWithLoader = (props) => {
  return /* @__PURE__ */ jsx249(DismissableModal, {
    children: /* @__PURE__ */ jsx249(ResolveCompositionBeforeModal, {
      compositionId: props.compositionId,
      children: /* @__PURE__ */ jsx249(RenderModal, {
        ...props
      })
    })
  });
...
import { useCallback as useCallback125, useContext as useContext80 } from "react";

// src/components/RenderModal/GuiRenderStatus.tsx
import { useCallback as useCallback124, useMemo as useMemo126 } from "react";
...
var SuccessIcon = () => {
  return /* @__PURE__ */ jsx250("svg", {
    style: iconStyle7,
    viewBox: "0 0 512 512",
    children: /* @__PURE__ */ jsx250("path", {
      fill: LIGHT_TEXT,
      d: "M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zM369 209L241 337l-17 17-17-17-64-64-17-17L160 222.1l17 17 47 47L335 175l17-17L385.9 192l-17 17z"
    })
  });
...
// src/components/RenderModal/GuiRenderStatus.tsx
import { jsx as jsx251, jsxs as jsxs130 } from "react/jsx-runtime";
var progressItem = {
  padding: 10,
  display: "flex",
  flexDirection: "row",
...
var BundlingProgress = ({ progress, doneIn }) => {
  return /* @__PURE__ */ jsxs130("div", {
    style: progressItem,
    children: [
      progress === 1 ? /* @__PURE__ */ jsx251(SuccessIcon, {}) : /* @__PURE__ */ jsx251(CircularProgress, {
        progress
      }),
...
var RenderingProgress = ({ progress }) => {
  return /* @__PURE__ */ jsxs130("div", {
    style: progressItem,
    children: [
      progress.frames === progress.totalFrames ? /* @__PURE__ */ jsx251(SuccessIcon, {}) : /* @__PURE__ */ jsx251(CircularProgress, {
...
var OpenFile = ({ job }) => {
  ...
  const onClick = useCallback124(() => {
    openInFileExplorer({ directory: job.outName });
  }, [job.outName]);
  return /* @__PURE__ */ jsxs130("div", {
    style: progressItem,
    children: [
      /* @__PURE__ */ jsx251(SuccessIcon, {}),
      /* @__PURE__ */ jsx251(Spacing, {
        x: 1
      }),
      /* @__PURE__ */ jsx251("button", {
        style: labelStyle5,
        type: "button",
        onClick,
        children: job.outName
      ...
      /* @__PURE__ */ jsx251("div", {
        style: right3,
        children: /* @__PURE__ */ jsx251(RenderQueueOpenInFinderItem, {
          job
        })
      })
    ]
...
var GuiRenderStatus = ({ job }) => {
  ...
  return /* @__PURE__ */ jsxs130("div", {
    children: [
      ...
      /* @__PURE__ */ jsx251(BundlingProgress, {
        progress: job.progress.bundling.progress,
        doneIn: job.progress.bundling.doneIn
      }),
      job.progress.rendering ? /* @__PURE__ */ jsx251(RenderingProgress, {
        progress: job.progress.rendering
      }) : null,
      job.progress.stitching ? /* @__PURE__ */ jsx251(StitchingProgress, {
        progress: job.progress.stitching
      }) : null,
      job.progress.downloads.length > 0 ? /* @__PURE__ */ jsx251(DownloadsProgress, {
        downloads: job.progress.downloads
      }) : null,
      job.status === "done" ? /* @__PURE__ */ jsx251(OpenFile, {
        job
      }) : null,
      /* @__PURE__ */ jsx251(Spacing, {
        y: 1
...
var RenderStatusModal = ({
  ...
  const { jobs } = useContext80(RenderQueueContext);
  const job = jobs.find((j) => j.id === jobId);
  if (!job) {
    throw new Error("job not found");
  }
  const onQuit = useCallback125(() => {
    setSelectedModal(null);
  }, [setSelectedModal]);
  const onRetry = useCallback125(() => {
    const retryPayload = makeRetryPayload(job);
    setSelectedModal(retryPayload);
  }, [job, setSelectedModal]);
  const onClickOnRemove = useCallback125(() => {
    setSelectedModal(null);
    removeRenderJob(job).catch((err) => {
      showNotification(`Could not remove job: ${err.message}`, 2000);
    });
  }, [job, setSelectedModal]);
  const onClickOnCancel = useCallback125(() => {
    cancelRenderJob(job).catch((err) => {
      showNotification(`Could not cancel job: ${err.message}`, 2000);
    });
  }, [job]);
  ...
  return /* @__PURE__ */ jsxs131(ModalContainer, {
    onOutsideClick: onQuit,
    onEscape: onQuit,
    children: [
      /* @__PURE__ */ jsx252(ModalHeader, {
      ...
      /* @__PURE__ */ jsxs131("div", {
        ...
        children: [
          ...
          job.status === "done" || job.status === "running" ? /* @__PURE__ */ jsx252(GuiRenderStatus, {
            job
          }) : null,
          /* @__PURE__ */ jsx252("div", {
            style: spacer3
          ...
          /* @__PURE__ */ jsxs131("div", {
            style: buttonRow,
            children: [
              job.status === "running" ? /* @__PURE__ */ jsx252(Button, {
                onClick: onClickOnCancel,
                children: "Cancel render"
              }) : /* @__PURE__ */ jsx252(Button, {
                onClick: onClickOnRemove,
                children: "Remove render"
              }),
              /* @__PURE__ */ jsx252(Flex, {}),
              job.status === "failed" ? /* @__PURE__ */ jsx252(Button, {
                onClick: onRetry,
                children: "Retry"
              }) : null,
              /* @__PURE__ */ jsx252("div", {
...
import { useCallback as useCallback128, useMemo as useMemo128 } from "react";

// src/components/CopyButton.tsx
import { useCallback as useCallback126, useEffect as useEffect75, useState as useState78 } from "react";
import { jsx as jsx253, jsxs as jsxs132 } from "react/jsx-runtime";
var iconStyle8 = {
  width: 16,
  height: 16,
  color: "white"
...
var copyIcon = /* @__PURE__ */ jsx253("svg", {
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "far",
  "data-icon": "clipboard",
...
var CopyButton = ({ textToCopy, label: label10, labelWhenCopied }) => {
  ...
  return /* @__PURE__ */ jsxs132(Button, {
    onClick,
    buttonContainerStyle,
    children: [
      copyIcon,
...
import { useCallback as useCallback127, useMemo as useMemo127, useState as useState79 } from "react";
...
var OpenIssueButton = ({ link: link3 }) => {
  ...
  const handleClick = useCallback127(() => {
    window.open(link3, "_blank");
  }, [link3]);
  const svgFillColor = useMemo127(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const openInEditorSvg = /* @__PURE__ */ jsx254("svg", {
    viewBox: "0 0 512 512",
    style: svgStyle3,
    children: /* @__PURE__ */ jsx254("path", {
      fill: svgFillColor,
      d: "M320 0c-17.7 0-32 14.3-32 32s14.3 32 32 32h82.7L201.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L448 109.3V192c0 17.7 14.3 32 32 32s32-14.3 32-32V32c0-17.7-14.3-32-32-32H320zM80 32C35.8 32 0 67.8 0 112V432c0 44.2 35.8 80 80 80H400c44.2 0 80-35.8 80-80V320c0-17.7-14.3-32-32-32s-32 14.3-32 32V432c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V112c0-8.8 7.2-16 16-16H192c17.7 0 32-14.3 32-32s-14.3-32-32-32H80z"
    })
  });
  const onPointerEnter = useCallback127(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback127(() => {
    setHovered(false);
  }, []);
  return /* @__PURE__ */ jsx254("button", {
    title: buttonTooltip,
    type: "button",
    onPointerEnter,
    onPointerLeave,
...
import { jsx as jsx255, jsxs as jsxs133 } from "react/jsx-runtime";
var container60 = {
  display: "flex",
  flexDirection: "row",
  alignItems: "center"
  ...
  const bugElements = bugs.map((bug) => {
    return /* @__PURE__ */ jsxs133("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx255(OpenIssueButton, {
          link: bug.link
        })
      ]
    }, bug.description + bug.link);
  });
  return /* @__PURE__ */ jsx255("div", {
...
var UpdateModal = ({ info, knownBugs }) => {
  const hasKnownBugs = useMemo128(() => {
    return knownBugs && knownBugs?.length > 0;
  }, [knownBugs]);
  const command = commands[info.packageManager];
  const onClick = useCallback128(() => {
    copyText(command).catch((err) => {
      showNotification(`Could not copy: ${err.message}`, 2000);
    });
  }, [command]);
  return /* @__PURE__ */ jsxs134(DismissableModal, {
    children: [
      /* @__PURE__ */ jsx256(ModalHeader, {
      ...
      /* @__PURE__ */ jsxs134("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs134(Row, {
            align: "center",
            children: [
              /* @__PURE__ */ jsx256(Flex, {
                children: /* @__PURE__ */ jsx256("pre", {
                  onClick,
                  style: code,
                  children: command
                })
...
var Modals = ({ readOnlyStudio }) => {
  ...
  return /* @__PURE__ */ jsxs135(Fragment44, {
    children: [
      ...
      modalContextType && modalContextType.type === "delete-comp" && /* @__PURE__ */ jsx257(DeleteComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && modalContextType.type === "rename-comp" && /* @__PURE__ */ jsx257(RenameComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && canRender && modalContextType.type === "render" && /* @__PURE__ */ jsx257(RenderModalWithLoader, {
      ...
      modalContextType && canRender && modalContextType.type === "render-progress" && /* @__PURE__ */ jsx257(RenderStatusModal, {
        jobId: modalContextType.jobId
      }),
      modalContextType && modalContextType.type === "update" && /* @__PURE__ */ jsx257(UpdateModal, {
        info: modalContextType.info,
        knownBugs: modalContextType.knownBugs
      }),
      modalContextType && modalContextType.type === "install-packages" && /* @__PURE__ */ jsx257(InstallPackageModal, {
        packageManager: modalContextType.packageManager
      }),
      modalContextType && modalContextType.type === "quick-switcher" && /* @__PURE__ */ jsx257(QuickSwitcher_default, {
        readOnlyStudio,
        invocationTimestamp: modalContextType.invocationTimestamp,
        initialMode: modalContextType.mode
      }),
      /* @__PURE__ */ jsx257(AskAiModal, {})
    ]
  });
};
...
var Editor = ({ Root, readOnlyStudio }) => {
  ...
  const [canvasMounted, setCanvasMounted] = React172.useState(false);
  const onMounted = useCallback129(() => {
  ...
  const MemoRoot = useMemo129(() => {
    return React172.memo(Root);
  }, [Root]);
  return /* @__PURE__ */ jsx258(HigherZIndex, {
    onEscape: noop,
    onOutsideClick: noop,
    children: /* @__PURE__ */ jsxs136(TimelineZoomContext, {
      children: [
        /* @__PURE__ */ jsx258(Internals60.CurrentScaleContext.Provider, {
          value,
          children: /* @__PURE__ */ jsxs136("div", {
            style: background2,
            children: [
              canvasMounted ? /* @__PURE__ */ jsx258(MemoRoot, {}) : null,
              /* @__PURE__ */ jsxs136(Internals60.CanUseRemotionHooksProvider, {
                children: [
                  /* @__PURE__ */ jsx258(EditorContent, {
                    readOnlyStudio,
                    children: /* @__PURE__ */ jsx258(TopPanel, {
                      drawRef,
                  ...
                  /* @__PURE__ */ jsx258(GlobalKeybindings, {})
                ]
              })
            ]
          })
        }),
        /* @__PURE__ */ jsx258(Modals, {
          readOnlyStudio
        }),
        /* @__PURE__ */ jsx258(NotificationCenter, {})
      ]
    })
  });
};
...
import { useCallback as useCallback130, useContext as useContext82, useMemo as useMemo130, useState as useState80 } from "react";
...
var PreviewSizeProvider = ({ children }) => {
  const [size4, setSizeState] = useState80(() => loadPreviewSizeOption());
  const [translation, setTranslation] = useState80(() => {
    return {
      x: 0,
      y: 0
    };
  });
  const { editorZoomGestures } = useContext82(EditorZoomGesturesContext);
  const setSize = useCallback130((newValue) => {
  ...
  const previewSizeCtx = useMemo130(() => {
    return {
  ...
  return /* @__PURE__ */ jsx259(Internals61.PreviewSizeContext.Provider, {
...
import { useCallback as useCallback131, useMemo as useMemo131, useState as useState81 } from "react";
import { jsx as jsx260 } from "react/jsx-runtime";
var CheckerboardProvider = ({ children }) => {
  const [checkerboard, setCheckerboardState] = useState81(() => loadCheckerboardOption());
  const setCheckerboard = useCallback131((newValue) => {
  ...
  const checkerboardCtx = useMemo131(() => {
    return {
      checkerboard,
      setCheckerboard
    };
  }, [checkerboard, setCheckerboard]);
  return /* @__PURE__ */ jsx260(CheckerboardContext.Provider, {
...
import { useMemo as useMemo132, useState as useState82 } from "react";
import { Internals as Internals62 } from "remotion";
import { jsx as jsx261 } from "react/jsx-runtime";
var MediaVolumeProvider = ({ children }) => {
  const [mediaMuted, setMediaMuted] = useState82(() => loadMuteOption());
  const [mediaVolume, setMediaVolume] = useState82(1);
  ...
  return /* @__PURE__ */ jsx261(Internals62.MediaVolumeContext.Provider, {
    value: mediaVolumeContextValue,
    children: /* @__PURE__ */ jsx261(Internals62.SetMediaVolumeContext.Provider, {
...
import { useMemo as useMemo133, useState as useState83 } from "react";
import { jsx as jsx262 } from "react/jsx-runtime";
var ModalsProvider = ({ children }) => {
  const [modalContextType, setModalContextType] = useState83(null);
  const modalsContext = useMemo133(() => {
    return {
      selectedModal: modalContextType,
      setSelectedModal: setModalContextType
    };
  }, [modalContextType]);
  return /* @__PURE__ */ jsx262(ModalsContext.Provider, {
    value: modalsContext,
    children
  });
};
...
import { useEffect as useEffect77, useMemo as useMemo134, useState as useState84 } from "react";
...
var SetTimelineInOutProvider = ({ children }) => {
  const [inAndOutFrames, setInAndOutFrames] = useState84(() => loadMarks());
  const setTimelineInOutContextValue = useMemo134(() => {
    return {
      setInAndOutFrames
    };
  }, []);
  ...
  return /* @__PURE__ */ jsx263(TimelineInOutContext.Provider, {
    value: inAndOutFrames,
    children: /* @__PURE__ */ jsx263(SetTimelineInOutContext.Provider, {
...
import { useCallback as useCallback132, useMemo as useMemo135, useRef as useRef41, useState as useState85 } from "react";
import { jsx as jsx264 } from "react/jsx-runtime";
var ShowGuidesProvider = ({ children }) => {
  const [guidesList, setGuidesList] = useState85(() => loadGuidesList());
  const [selectedGuideId, setSelectedGuideId] = useState85(null);
  const [hoveredGuideId, setHoveredGuideId] = useState85(null);
  const [editorShowGuides, setEditorShowGuidesState] = useState85(() => loadEditorShowGuidesOption());
  const shouldCreateGuideRef = useRef41(false);
  const shouldDeleteGuideRef = useRef41(false);
  const setEditorShowGuides = useCallback132((newValue) => {
  ...
  const editorShowGuidesCtx = useMemo135(() => {
    return {
      editorShowGuides,
      setEditorShowGuides,
      guidesList,
  ...
  return /* @__PURE__ */ jsx264(EditorShowGuidesContext.Provider, {
...
import { useCallback as useCallback133, useMemo as useMemo136, useState as useState86 } from "react";
import { jsx as jsx265 } from "react/jsx-runtime";
var ShowRulersProvider = ({ children }) => {
  const [editorShowRulers, setEditorShowRulersState] = useState86(() => loadEditorShowRulersOption());
  const setEditorShowRulers = useCallback133((newValue) => {
  ...
  const editorShowRulersCtx = useMemo136(() => {
    return {
      editorShowRulers,
      setEditorShowRulers
    };
  }, [editorShowRulers, setEditorShowRulers]);
  return /* @__PURE__ */ jsx265(EditorShowRulersContext.Provider, {
...
import { useCallback as useCallback134, useMemo as useMemo137, useState as useState87 } from "react";
import { jsx as jsx266 } from "react/jsx-runtime";
var ZoomGesturesProvider = ({ children }) => {
  const [editorZoomGestures, setEditorZoomGesturesState] = useState87(() => loadEditorZoomGesturesOption());
  const setEditorZoomGestures = useCallback134((newValue) => {
  ...
  const editorZoomGesturesCtx = useMemo137(() => {
    return {
      editorZoomGestures,
      setEditorZoomGestures
    };
  }, [editorZoomGestures, setEditorZoomGestures]);
  return /* @__PURE__ */ jsx266(EditorZoomGesturesContext.Provider, {
...
var EditorContexts = ({ children, readOnlyStudio }) => {
  return /* @__PURE__ */ jsx267(ZodProvider, {
    children: /* @__PURE__ */ jsx267(VisualControlsProvider, {
      children: /* @__PURE__ */ jsx267(PreviewServerConnection, {
        readOnlyStudio,
        children: /* @__PURE__ */ jsx267(RenderQueueContextProvider, {
          children: /* @__PURE__ */ jsx267(KeybindingContextProvider, {
            children: /* @__PURE__ */ jsx267(CheckerboardProvider, {
              children: /* @__PURE__ */ jsx267(ZoomGesturesProvider, {
                children: /* @__PURE__ */ jsx267(ShowRulersProvider, {
                  children: /* @__PURE__ */ jsx267(ShowGuidesProvider, {
                    children: /* @__PURE__ */ jsx267(PreviewSizeProvider, {
                      children: /* @__PURE__ */ jsx267(ModalsProvider, {
                        children: /* @__PURE__ */ jsx267(MediaVolumeProvider, {
                          children: /* @__PURE__ */ jsx267(PlayerInternals20.PlayerEmitterProvider, {
                            currentPlaybackRate: null,
                            children: /* @__PURE__ */ jsx267(SidebarContextProvider, {
                              children: /* @__PURE__ */ jsx267(FolderContextProvider, {
                                children: /* @__PURE__ */ jsx267(HighestZIndexProvider, {
                                  children: /* @__PURE__ */ jsx267(SetTimelineInOutProvider, {
                                    children
                                  })
                                })
                              })
...
import { useContext as useContext83 } from "react";
import { jsx as jsx268, jsxs as jsxs137 } from "react/jsx-runtime";
var container62 = {
  position: "fixed",
  justifyContent: "flex-end",
  alignItems: "flex-start",
...
var ServerDisconnected = () => {
  ...
  return /* @__PURE__ */ jsx268("div", {
    style: container62,
    className: "css-reset",
    children: /* @__PURE__ */ jsxs137("div", {
      style: message,
      children: [
        "The studio server has disconnected. ",
        /* @__PURE__ */ jsx268("br", {}),
        window.remotion_studioServerCommand ? /* @__PURE__ */ jsxs137("span", {
          children: [
            "Run",
            " ",
            /* @__PURE__ */ jsx268("code", {
              style: inlineCode,
...
var injectCSS = () => {
  ...
  Internals63.CSSUtils.injectCSS(makeDefaultGlobalCSS());
  injected = true;
};

// src/Studio.tsx
import { jsx as jsx269, jsxs as jsxs138 } from "react/jsx-runtime";
...
var Studio = ({ rootComponent, readOnly }) => {
  useLayoutEffect2(() => {
    ...
    Internals64.enableSequenceStackTraces();
    return () => {
  ...
  return /* @__PURE__ */ jsx269(Internals64.RemotionRoot, {
    ...
    children: /* @__PURE__ */ jsxs138(EditorContexts, {
      ...
      children: [
        /* @__PURE__ */ jsx269(Editor, {
          readOnlyStudio: readOnly,
          Root: rootComponent
        }),
        readOnly ? null : createPortal(/* @__PURE__ */ jsx269(ServerDisconnected, {}), getServerDisconnectedDomElement())
      ]
    })
  });
};
